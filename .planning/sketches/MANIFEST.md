...
| 008 | phase-17-counterparty-profile-type-variants | How does the 007 winner shape flex across personal / bank / government / self_account types? | _pending_ | counterparties, profile, types, privacy, phase-17 |
| 009 | phase-17-counterparty-index | How are all counterparties listed — dense Linear list vs card grid vs ledger table? Type-filter chip UX. | _pending_ | counterparties, index, filter, phase-17 |

...
/**
 * Synthesises the Phase 5 cross-source matching fixture trio:
 *
 ...
 *
 * Usage:
 *     php scripts/synthesise_phase5_scenario.php
 */
mt_srand(20260516);
...
$md = "# Phase 5 scenario-1 — synthesised cross-source fixture\n\n"
    ...
    ."`scripts/synthesise_phase5_scenario.php`. Re-run produces\n"
    ...
    ."## Idempotency\n\n"
    ."Run `php scripts/synthesise_phase5_scenario.php` twice in a row on a\n"
...
function makePaypalCsv(): string
{
    ...
    // The "Naam bank" cell holds the IBAN to mirror the D-106 hand-off.

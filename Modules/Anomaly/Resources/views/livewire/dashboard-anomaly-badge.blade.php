...
@php
    ...
    $labels = ['large' => 'large', 'first_time' => 'first-time', 'duplicate' => 'duplicate'];
    $parts = [];
...
<div>
    @if ($openCount > 0)
        <a
            ...
            aria-label="Unusual charges — {{ $openCount }} open"
        >
            <p class="text-base font-semibold text-slate-900 dark:text-slate-100">Unusual charges</p>

...
return [
    ...
    'empty_body' => 'Οι κανόνες αντιστοιχίζουν συναλλαγές με βάση πολλαπλές συνθήκες και εφαρμόζουν αυτόματα αλλαγές σε κατηγορία, αντισυμβαλλόμενο και σημείωση κατά την εισαγωγή. Μια αλλαγή φορολογικής ετικέτας εφαρμόζεται όταν εφαρμόσεις ξανά τους κανόνες στο υπάρχον ιστορικό σου.',

...
// Driven by a Livewire-local `correction-divergence:fire` event rather than a
// broadcast or a session flash: Echo would need Reverb, a flash a redirect.
final class CorrectionDivergenceToast extends Component
{
    ...
    public function handleDiverged(
        ...
        // $userId is the event-carried owner of the rule and transaction; a
        // mismatch with the authenticated user is a silent no-op.
        ...
        // Resolve the old category's path directly: by the time this fires the
        // rule may already differ from whatever produced $oldCategoryId.
    ...
    public function update(
        ...
        try {
            ...
            // A NotFoundHttpException means the ruleId maps to no visible row,
            // so the toast has nothing left to offer; the other two are
            // unreachable in normal use and leave it open.

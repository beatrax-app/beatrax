<div class="space-y-6">
    <header class="space-y-1">
        ...
        <p class="sr-only" id="upload-statement-mime-hint">That file doesn't look like an ASN export. Drop in the CSV or CAMT.053 XML you downloaded from the ASN portal.</p>
    </header>

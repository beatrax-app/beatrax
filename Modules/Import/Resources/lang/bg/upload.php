...
return [
    ...
    'mime_hint' => 'Този файл не изглежда като поддържан експорт на извлечение. Пусни банков CSV, MT940 (.sta / .mt940 / .txt), CAMT.053 XML, PDF с извлечение по карта, имейл съобщение (.eml) или архив на пощенска кутия (.mbox).',

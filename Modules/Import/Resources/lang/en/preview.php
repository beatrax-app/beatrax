...
return [
    ...
    'failed' => [
        ...
        'truncated' => 'Reading stopped part-way through the file. This file cannot be imported: filing only the part that was read would leave the rest of the period missing, with nothing to say so.',
        'truncated_action' => 'Upload the file again, or download a fresh copy of the statement from your bank.',

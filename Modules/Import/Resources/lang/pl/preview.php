...
return [
    ...
    'failed' => [
        ...
        'truncated' => 'Odczyt zatrzymał się w połowie pliku. Tego pliku nie można zaimportować: zapisanie tylko odczytanej części sprawiłoby, że reszta okresu byłaby nieobecna i nic by tego nie sygnalizowało.',
        'truncated_action' => 'Prześlij plik ponownie lub pobierz nową kopię wyciągu ze swojego banku.',

...
return [
    ...
    'failed' => [
        ...
        'truncated' => 'Okuma dosyanın ortasında durdu. Bu dosya içe aktarılamaz: yalnızca okunan kısmı kaydetmek dönemin geri kalanını eksik bırakır ve bunu belirten hiçbir şey olmaz.',
        'truncated_action' => 'Dosyayı yeniden yükleyin veya bankanızdan ekstrenin yeni bir kopyasını indirin.',

...
return [
    ...
    'failed' => [
        ...
        'truncated' => 'Het inlezen is halverwege het bestand gestopt. Dit bestand kan niet worden geïmporteerd: alleen het gelezen deel opslaan zou de rest van de periode laten ontbreken, zonder dat iets dat aangeeft.',
        'truncated_action' => 'Upload het bestand opnieuw of download een nieuw exemplaar van het afschrift bij je bank.',

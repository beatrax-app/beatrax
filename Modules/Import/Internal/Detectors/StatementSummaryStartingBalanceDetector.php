...
abstract class StatementSummaryStartingBalanceDetector implements DetectsStartingBalance
{
    use CoercesScalars;

    public function __construct(private readonly DatabaseManager $db) {}

    abstract protected function sourceFormat(): string;

    public function supports(string $sourceFormat): bool
    {
        return $sourceFormat === $this->sourceFormat();
    }

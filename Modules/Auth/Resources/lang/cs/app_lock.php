...
return [
    ...
    'error_enroll_device_refused' => 'Tvoje zařízení biometrické odemykání nenabídlo. Pokud umí otisk prstu nebo obličej, ulož si ho v nastavení zařízení a zkus to znovu — do té doby je tu jediné odemknutí tvůj PIN.',
    ...
    'enroll_modal_heading' => 'Zapnout biometrické odemykání — potvrď PINem',
    ...
    'auto_lock_note' => 'Beatrax se zamkne po této době bez aktivity — a dřív, když ho opustíš: přepnutí do jiné aplikace nebo skrytí či zavření okna zamkne Beatrax do :window bez ohledu na toto nastavení.',
    'idle_1' => '1 minutě',
    'idle_5' => '5 minutách',
    'idle_15' => '15 minutách',
    'idle_30' => '30 minutách',
    ...
    'forgot_modal_body' => 'Heslo k účtu obnoví klíč zámku, takže při resetu PINu o žádná data nepřijdeš — pokud tím heslem zámek pořád jde otevřít. Heslo obnovené záložním kódem nebo nastavené vlastníkem účtu už ho neotevře.',
    ...
    'error_vault_kept_key' => 'Biometrické odemykání je vypnuté, ale tento počítač uložený klíč nesmazal, takže je tu jeho kopie pořád. Restartuj Beatrax a odeber ho znovu.',
    ...
    'error_key_material_lost' => 'Toto zařízení už nedrží klíč, který otevírá tvoje šifrovaná data, takže nový PIN je znovu čitelnými neudělá. Obnov šifrovanou zálohu pořízenou v době, kdy klíč ještě fungoval — spárováním se toto zařízení zpátky nedostane, protože párování potřebuje zámek aplikace, který ten klíč otevírá.',

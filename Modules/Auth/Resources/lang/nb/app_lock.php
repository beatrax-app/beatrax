...
return [
    ...
    'error_enroll_device_refused' => 'Enheten din tilbød ikke biometrisk opplåsing. Hvis den kan bruke fingeravtrykk eller ansikt, lagre ett i enhetsinnstillingene og prøv igjen — inntil da er PIN-koden din den eneste opplåsingen her.',
    ...
    'error_enroll_pin_expired' => 'Bekreftelsen med PIN-kode utløp før enheten ble ferdig. Skriv inn PIN-koden din og prøv igjen.',
    'heading' => 'Applås',
    ...
    'auto_lock_note' => 'Beatrax låser etter så lang tid uten aktivitet — og tidligere hvis du forlater den: å bytte til en annen app eller skjule eller lukke vinduet låser Beatrax innen :window, uansett hva denne innstillingen sier.',
    'idle_1' => '1 minutt',
    'idle_5' => '5 minutter',
    'idle_15' => '15 minutter',
    'idle_30' => '30 minutter',
    ...
    'error_vault_kept_key' => 'Biometrisk opplåsing er av, men denne datamaskinen slettet ikke den lagrede nøkkelen, så en kopi ligger her fortsatt. Start Beatrax på nytt og fjern den igjen.',

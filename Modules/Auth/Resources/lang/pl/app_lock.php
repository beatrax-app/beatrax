...
return [
    ...
    'error_enroll_device_refused' => 'Twoje urządzenie nie zaoferowało odblokowania biometrycznego. Jeśli obsługuje odcisk palca lub twarz, zapisz go w ustawieniach urządzenia i spróbuj ponownie — do tego czasu jedynym odblokowaniem jest tutaj Twój PIN.',
    ...
    'error_enroll_pin_expired' => 'Potwierdzenie PIN-em wygasło, zanim urządzenie zakończyło. Wpisz PIN i spróbuj ponownie.',
    ...
    'enroll_modal_heading' => 'Włącz odblokowanie biometryczne — potwierdź PIN-em',
    ...
    'auto_lock_note' => 'Beatrax blokuje się po tym czasie bez aktywności — i wcześniej, gdy go opuścisz: przełączenie się na inną aplikację albo ukrycie lub zamknięcie okna blokuje Beatrax w ciągu :window, niezależnie od tego ustawienia.',
    'idle_1' => '1 minucie',
    'idle_5' => '5 minutach',
    'idle_15' => '15 minutach',
    'idle_30' => '30 minutach',
    ...
    'error_pin_digits' => 'PIN musi mieć od :min do :max cyfr — tylko cyfry.',

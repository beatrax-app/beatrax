...
return [
    'error_enroll_unsupported' => 'Den här versionen av Beatrax har ingenstans att lagra en upplåsningsnyckel, så biometrisk upplåsning erbjuds inte. Begränsningen är inte din enhet.',
    'error_enroll_device_refused' => 'Din enhet erbjöd ingen biometrisk upplåsning. Om den kan använda fingeravtryck eller ansikte, spara ett i enhetens inställningar och försök igen — tills dess är din PIN-kod den enda upplåsningen här.',
    ...
    'error_enroll_pin_expired' => 'Bekräftelsen med PIN-kod gick ut innan din enhet blev klar. Ange din PIN-kod och försök igen.',
    'heading' => 'Applås',
    ...
    'remove' => 'Ta bort',
    'enroll' => 'Registrera',
    'biometric_unavailable' => 'Den här versionen av Beatrax kan inte erbjuda biometrisk upplåsning. Din PIN-kod är den enda upplåsningen här.',

    'deenroll_modal_heading' => 'Ta bort biometrisk upplåsning — bekräfta med PIN-kod',
    'enroll_modal_heading' => 'Slå på biometrisk upplåsning — bekräfta med PIN-kod',
    ...
    'auto_lock_note' => 'Beatrax låser efter så lång tid utan aktivitet — och tidigare om du lämnar den: att växla till en annan app eller dölja eller stänga fönstret låser Beatrax inom :window, oavsett vad den här inställningen säger.',
    'idle_1' => '1 minut',
    'idle_5' => '5 minuter',
    'idle_15' => '15 minuter',
    'idle_30' => '30 minuter',
    ...
    'error_vault_kept_key' => 'Biometrisk upplåsning är av, men den här datorn raderade inte den sparade nyckeln, så en kopia ligger kvar här. Starta om Beatrax och ta bort den igen.',

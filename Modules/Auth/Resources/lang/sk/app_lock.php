...
return [
    ...
    'enroll_modal_heading' => 'Zapnúť biometrické odomknutie — potvrď PIN-om',
    ...
    'auto_lock_note' => 'Beatrax sa zamkne po tomto čase bez aktivity — a skôr, keď ho opustíš: prepnutie do inej aplikácie alebo skrytie či zatvorenie okna zamkne Beatrax do :window bez ohľadu na toto nastavenie.',
    'idle_1' => '1 minúte',
    'idle_5' => '5 minútach',
    'idle_15' => '15 minútach',
    'idle_30' => '30 minútach',
    ...
    'relink_recovery_success' => 'Heslo k účtu môže tento zámok aplikácie opäť obnoviť.',
];

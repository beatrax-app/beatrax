<div class="min-h-screen flex items-center justify-center bg-white dark:bg-slate-950">
    <div class="w-full max-w-sm px-6 space-y-6">
        <header class="space-y-1">
            <h1 class="text-3xl font-semibold text-slate-900 tracking-tight dark:text-slate-100">Reset your password</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400">Type your username, one of your recovery codes, and a new password. The code will be marked used.</p>
        </header>
        ...
        <form wire:submit="submit" class="space-y-4">
            ...
            <div class="space-y-1">
                <label for="recovery-code" class="block text-sm text-slate-900 dark:text-slate-100">Recovery code</label>
                <input
                    type="text"
                    id="recovery-code"
                ...
                />
                <p class="text-xs text-slate-500 dark:text-slate-400">5 groups of 4 characters, like A2BJ-XK9M-PQ7N-RX4F-V8HD.</p>
            </div>

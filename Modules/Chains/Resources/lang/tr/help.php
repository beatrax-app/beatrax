...
return [
    ...
    'hints' => 'İpucu, bağlantının yarısıdır: Beatrax bir ödeme zincirinin bir ucunu bulmuş, diğerini bulamamış ve gerisini tahmin etmek yerine gördüğünü not etmiştir. Çoğu kendiliğinden çözülür — bir ödeme, karşıladığı tek tek harcamalar içeri alınana kadar burada bekler, sonra gerçek bir zincire dönüşür. Kalanları gönül rahatlığıyla eleyebilirsin; kayıtlarında her iki durumda da hiçbir şey değişmez.',
];

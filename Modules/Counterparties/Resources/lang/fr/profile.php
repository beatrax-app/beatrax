...
return [
    ...
    'merchant' => [
        ...
        'categories_empty_html' => 'Aucune catégorie pour l\'instant — les transactions non catégorisées apparaissent dans <a href=":url" style="color: var(--color-text); text-decoration: underline;">Catégorisation</a>.',

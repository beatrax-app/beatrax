...
return [
    ...
    'merchant' => [
        ...
        'categories_empty_html' => 'No categories yet — uncategorized transactions appear in <a href=":url" style="color: var(--color-text); text-decoration: underline;">Categorization</a>.',

...
return [
    ...
    'chain_flow' => [
        'aria' => 'Верига на финансиране: :chain',
        'join' => ' към ',
    ],
    ...
    'privacy_banner' => [
        ...
        'body' => '🔒 Това е личен контакт. IBAN остава скрит, докато не го покажеш, и не влиза в експортите. Името на контакта продължава да се вижда навсякъде, където се появяват транзакциите му.',
    ],

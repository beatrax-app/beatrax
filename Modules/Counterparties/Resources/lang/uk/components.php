...
return [
    ...
    'chain_flow' => [
        'aria' => 'Ланцюг фінансування: :chain',
        'join' => ' до ',
    ],
    ...
    'privacy_banner' => [
        ...
        'body' => '🔒 Це особистий контакт. IBAN приховано, доки ти його не покажеш, і в експорт він не потрапляє. Ім’я контакту й далі з’являється всюди, де з’являються його транзакції.',
    ],

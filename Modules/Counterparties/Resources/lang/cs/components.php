...
return [
    ...
    'chain_flow' => [
        'aria' => 'Řetězec financování: :chain',
        'join' => ' do ',
    ],
    ...
    'privacy_banner' => [
        ...
        'body' => '🔒 Toto je osobní kontakt. IBAN zůstává skrytý, dokud ho nezobrazíš, a do exportů se nedostane. Jméno kontaktu se dál objevuje všude, kde se objevují jeho transakce.',
    ],

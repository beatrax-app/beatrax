...
final readonly class CounterpartyProfileQuery
{
    ...
    public function recentActivity(Counterparty $cp, int $limit = 10): Collection
    {
        ...
        // $limit makes this order decide WHICH rows the list holds, not only
        // their sequence, and `id` is counted per device — so the profile
        // printed one recent-activity list here and another one there.

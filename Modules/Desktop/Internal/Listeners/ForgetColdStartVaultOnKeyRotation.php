...
// A passphrase change re-wraps the data key, so whatever the vault holds can
// no longer decrypt. Dropping it turns a guaranteed failed Touch ID unlock
// into a clean PIN prompt, and re-enrolment happens on that unlock.
/**

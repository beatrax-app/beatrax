...
| `MenuBar` | ABSENT | — | No `fake()` method and no `*Fake` class. System-tray (`MenuBar`) wiring is verified through the module builder output; the live facade call is manual-UAT only. |

...
return [
    ...
    'projection' => [
        ...
        'building' => 'Creazione della proiezione…',
        'est' => 'Stima :date ·',
    ...
    'form' => [
        ...
        'subtitle_edit' => "Aggiorna il nome, l'importo obiettivo, la data o il conto collegato.",
        ...
        'savings_account' => 'Conto di risparmio (facoltativo)',
        'no_account' => 'Nessun conto — monitoraggio manuale',
        'linked_pot' => 'Salvadanaio collegato (facoltativo)',
        'select_account_first' => 'Seleziona prima un conto',
    ...
    'errors' => [
        ...
        'account_not_owned' => "Il conto non appartiene all'utente autenticato.",
    ],
];

...
return [
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Update the name, target, date, or linked account.',
        ...
        'savings_account' => 'Savings account (optional)',
        'no_account' => 'No account — track manually',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'Account not owned by the authenticated user.',
    ],
];

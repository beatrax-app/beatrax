...
return [
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Actualizează numele, ținta, data sau contul asociat.',
        ...
        'savings_account' => 'Cont de economii (opțional)',
        'no_account' => 'Fără cont — urmărire manuală',
        'linked_pot' => 'Pușculiță asociată (opțional)',
        'select_account_first' => 'Alege întâi un cont',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'Contul nu aparține utilizatorului autentificat.',
    ],
];

...
return [
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Zaktualizuj nazwę, kwotę docelową, datę lub powiązane konto.',
        ...
        'savings_account' => 'Konto oszczędnościowe (opcjonalnie)',
        'no_account' => 'Bez konta — śledź ręcznie',
        'linked_pot' => 'Powiązana skarbonka (opcjonalnie)',
        'select_account_first' => 'Najpierw wybierz konto',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'Konto nie należy do zalogowanego użytkownika.',
    ],
];

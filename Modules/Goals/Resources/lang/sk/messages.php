...
return [
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Uprav názov, cieľovú sumu, dátum alebo prepojený účet.',
        ...
        'savings_account' => 'Sporiaci účet (voliteľné)',
        'no_account' => 'Bez účtu — sledovať ručne',
        'linked_pot' => 'Prepojená sporiaca obálka (voliteľné)',
        'select_account_first' => 'Najprv vyber účet',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'Účet nepatrí prihlásenému používateľovi.',
    ],
];

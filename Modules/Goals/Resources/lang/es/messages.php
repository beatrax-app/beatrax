...
return [
    ...
    'projection' => [
        ...
        'building' => 'Calculando una previsión…',
        'est' => 'Est. :date ·',
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Actualiza el nombre, el importe objetivo, la fecha o la cuenta vinculada.',
        ...
        'savings_account' => 'Cuenta de ahorro (opcional)',
        'no_account' => 'Sin cuenta — seguimiento manual',
        'linked_pot' => 'Hucha vinculada (opcional)',
        'select_account_first' => 'Elige primero una cuenta',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'La cuenta no pertenece al usuario autenticado.',
    ],
];

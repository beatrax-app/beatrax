...
return [
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Uppdatera namn, målbelopp, datum eller kopplat konto.',
        ...
        'savings_account' => 'Sparkonto (valfritt)',
        'no_account' => 'Inget konto — följ manuellt',
        'linked_pot' => 'Kopplad sparpott (valfritt)',
        'select_account_first' => 'Välj ett konto först',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'Kontot ägs inte av den inloggade användaren.',
    ],
];

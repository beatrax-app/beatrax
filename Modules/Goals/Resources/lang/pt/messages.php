...
return [
    ...
    'projection' => [
        ...
        'building' => 'A construir uma projeção…',
        'est' => 'Est. :date ·',
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Atualiza o nome, a meta, a data ou a conta associada.',
        ...
        'savings_account' => 'Conta poupança (opcional)',
        'no_account' => 'Sem conta — acompanhar manualmente',
        'linked_pot' => 'Reserva associada (opcional)',
        'select_account_first' => 'Seleciona primeiro uma conta',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'A conta não pertence ao utilizador autenticado.',
    ],
];

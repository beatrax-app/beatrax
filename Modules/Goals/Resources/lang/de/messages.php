...
return [
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Aktualisiere Name, Zielbetrag, Datum oder verknüpftes Konto.',
        ...
        'savings_account' => 'Sparkonto (optional)',
        'no_account' => 'Kein Konto — manuell verfolgen',
        'linked_pot' => 'Verknüpfte Rücklage (optional)',
        'select_account_first' => 'Wähle zuerst ein Konto',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'Das Konto gehört nicht der angemeldeten Person.',
    ],
];

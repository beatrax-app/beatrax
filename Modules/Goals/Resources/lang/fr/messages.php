...
return [
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Modifie le nom, le montant cible, la date ou le compte lié.',
        ...
        'savings_account' => 'Compte d\'épargne (facultatif)',
        'no_account' => 'Aucun compte — suivi manuel',
        'linked_pot' => 'Cagnotte liée (facultatif)',
        'select_account_first' => 'Choisis d\'abord un compte',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'Ce compte n\'appartient pas à l\'utilisateur connecté.',
    ],
];

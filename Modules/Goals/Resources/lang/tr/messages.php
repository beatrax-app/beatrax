...
return [
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Adı, hedef tutarı, tarihi ya da bağlı hesabı güncelle.',
        ...
        'savings_account' => 'Birikim hesabı (isteğe bağlı)',
        'no_account' => 'Hesap yok — elle izle',
        'linked_pot' => 'Bağlı kumbara (isteğe bağlı)',
        'select_account_first' => 'Önce bir hesap seç',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'Hesap, kimliği doğrulanmış kullanıcıya ait değil.',
    ],
];

...
return [
    ...
    'form' => [
        ...
        'subtitle_edit' => 'Päivitä nimi, tavoitesumma, päivämäärä tai liitetty tili.',
        ...
        'savings_account' => 'Säästötili (valinnainen)',
        'no_account' => 'Ei tiliä — seuraa manuaalisesti',
        'linked_pot' => 'Liitetty säästöpotti (valinnainen)',
        'select_account_first' => 'Valitse ensin tili',
    ...
    'errors' => [
        ...
        'account_not_owned' => 'Tili ei kuulu kirjautuneelle käyttäjälle.',
    ],
];

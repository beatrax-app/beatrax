...
/*
 * /recurring/review page tests — Livewire SFC, the three-tab queue
 * (pending / rejected / cadence-changed), the four per-row actions
 * (approve / reject / snooze / edit name), the 10s Undo toast, and
 * the auth gate.
 */

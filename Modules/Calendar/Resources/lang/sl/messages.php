...
return [
    ...
    'summary' => [
        ...
        'risk' => 'Stanje pade pod €0 v :count dnevu — prvi: :date.|Stanje pade pod €0 v :count dneh — prvi: :date.|Stanje pade pod €0 v :count dneh — prvi: :date.|Stanje pade pod €0 v :count dneh — prvi: :date.',
    ],

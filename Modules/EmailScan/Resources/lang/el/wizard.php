...
return [
    ...
    'secret_help' => 'Αποθηκεύεται κρυπτογραφημένο στη βάση δεδομένων αυτής της συσκευής. Το Beatrax το στέλνει μόνο στη Google ή τη Microsoft, για να λάβει και να ανανεώνει το token πρόσβασής σου — πουθενά αλλού.',
    ...
    'errors' => [
        ...
        'write_failed' => 'Δεν ήταν δυνατή η αποθήκευση του πελάτη OAuth — η εγγραφή στη βάση δεδομένων αυτής της συσκευής απέτυχε. Δοκίμασε ξανά.',
    ],
];

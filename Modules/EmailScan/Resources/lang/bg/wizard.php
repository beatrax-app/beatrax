...
return [
    ...
    'secret_help' => 'Те се съхраняват в локален конфигурационен файл извън базата данни, с ограничени права, и никога не напускат това устройство.',
    ...
    'errors' => [
        ...
        'write_failed' => 'OAuth клиентът не можа да бъде записан на диска — провери правата на директорията с тайни и опитай отново.',
    ],
];

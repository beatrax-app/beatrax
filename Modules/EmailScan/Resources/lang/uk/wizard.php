...
return [
    ...
    'secret_help' => 'Вони зберігаються в локальному файлі конфігурації поза базою даних з обмеженими правами доступу й ніколи не залишають цей пристрій.',
    ...
    'errors' => [
        ...
        'write_failed' => 'Не вдалося зберегти твій OAuth-клієнт на диск — перевір права доступу до каталогу секретів і спробуй ще раз.',
    ],
];

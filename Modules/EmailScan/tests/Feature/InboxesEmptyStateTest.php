...
it('renders the empty-state hero when zero inboxes are connected', function (): void {
    ...
    $response->assertSee('Connect Gmail and Microsoft 365 inboxes so diederik can scan them for receipts.', false);
    ...
    $response->assertSee('diederik only reads messages.', false);

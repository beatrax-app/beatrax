...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'los demás avisos',
    ],
    ...
    'messages' => [
        ...
        'update_refused' => 'Beatrax descargó la versión :version y se negó a instalarla: el archivo no coincidía con la firma del editor, así que no se cambió nada en este dispositivo. Una descarga dañada puede provocarlo. Si vuelve a pasar, no instales Beatrax desde esa fuente.',
        ...
        'schema_shape_drifted' => 'Faltan en este dispositivo algunas de las protecciones que Beatrax incorpora a la base de datos, por lo que eliminar algo puede llevarse consigo registros vinculados sin avisar y un ajuste puede guardarse en un formato que Beatrax no puede volver a leer. No se ha perdido nada de lo que has introducido. Beatrax repara lo que puede cada vez que se inicia, así que reiniciar suele resolverlo.',
        ...
        'sync_blind_index_diverged' => 'Dos de tus dispositivos activaron el cifrado en reposo por separado, antes de que los vincularas, así que cada uno reconoce los comercios con su propia clave. Todo se sigue sincronizando, pero un comercio que conoce un dispositivo es un desconocido para el otro: los comercios aparecen dos veces y un pago recurrente puede detectarse dos veces. Beatrax no fusionará las dos claves, porque la que descartara se llevaría consigo el historial de coincidencias propio de ese dispositivo. La salida es volver a configurar uno de los dispositivos desde cero y dejar que tome su copia del otro.',

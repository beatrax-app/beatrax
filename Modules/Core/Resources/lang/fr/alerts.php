...
return [
    ...
    'messages' => [
        ...
        'schema_shape_drifted' => 'Une partie des protections que Beatrax intègre à la base de données manque sur cet appareil : une suppression peut donc emporter discrètement des enregistrements liés, et un réglage peut être enregistré sous une forme que Beatrax ne sait pas relire. Rien de ce que vous avez saisi n\'est perdu. Beatrax répare ce qu\'il peut à chaque démarrage, un redémarrage règle donc généralement ce point.',
        ...
        'sync_blind_index_diverged' => 'Deux de vos appareils ont activé le chiffrement au repos séparément, avant que vous ne les appairiez, si bien que chacun reconnaît les commerçants sous sa propre clé. Tout se synchronise toujours, mais un commerçant que l’un des appareils connaît est un inconnu pour l’autre : les commerçants apparaissent en double et un paiement récurrent peut être détecté deux fois. Beatrax ne fusionnera pas les deux clés, car celle qu’il abandonnerait emporterait avec elle l’historique de correspondances propre à cet appareil. La sortie consiste à reconfigurer l’un des appareils depuis zéro et à le laisser reprendre sa copie depuis l’autre.',

...
return [
    ...
    'errors' => [
        ...
        'choose_file' => 'Neyden geri yükleneceğini seç: .enc yedek dosyası ya da tek tıkla dışa aktarmanın yazdığı .zip.',
        ...
        'restore_not_a_backup' => 'Bu dosya bir Beatrax yedeği içermiyor, dolayısıyla geri yüklenecek bir şey yok ve hiçbir şey değişmedi. Yedeği alırken uygulamanın yazdığı .enc dosyasını ya da tek tıkla dışa aktarmanın yazdığı .zip dosyasını seç.',

...
return [
    ...
    'messages' => [
        ...
        'sync_blind_index_diverged' => 'İki cihazınız bekleyen veri şifrelemesini, siz onları eşleştirmeden önce ayrı ayrı açtı; bu yüzden her biri işyerlerini kendi anahtarıyla tanıyor. Her şey hâlâ senkronize ediliyor, ancak bir cihazın tanıdığı işyeri diğeri için bir yabancı: işyerleri iki kez görünüyor ve düzenli bir ödeme iki kez bulunabiliyor. Beatrax iki anahtarı birleştirmeyecek, çünkü bıraktığı anahtar o cihazın kendi eşleşme geçmişini de birlikte götürürdü. Çıkış yolu, cihazlardan birini sıfırdan yeniden kurmak ve kopyasını diğerinden almasına izin vermektir.',

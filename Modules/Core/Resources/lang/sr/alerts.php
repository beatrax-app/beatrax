...
return [
    ...
    'messages' => [
        ...
        'schema_shape_drifted' => 'Na ovom uređaju nedostaje deo zaštita koje Beatrax ugrađuje u bazu podataka, pa brisanje može tiho da povuče povezane zapise sa sobom, a podešavanje može da se sačuva u obliku koji Beatrax ne može da pročita nazad. Ništa od onoga što ste uneli nije izgubljeno. Beatrax pri svakom pokretanju popravi što može, pa ponovno pokretanje to obično reši.',
        ...
        'sync_blind_index_diverged' => 'Dva uređaja uključila su šifrovanje u mirovanju svaki za sebe, pre nego što ste ih uparili, pa svaki prepoznaje trgovce pod sopstvenim ključem. Sve se i dalje sinhronizuje, ali trgovac kojeg jedan uređaj poznaje drugom je stranac: trgovci se pojavljuju dvaput, a ponavljajuće plaćanje može da se pronađe dva puta. Beatrax neće spojiti dva ključa jer bi onaj koji bi odbacio sa sobom odneo sopstvenu istoriju podudaranja tog uređaja. Izlaz je da jedan uređaj podesite iznova od nule i pustite ga da svoju kopiju preuzme sa drugog.',

...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'gli altri avvisi',
    ],
    ...
    'messages' => [
        ...
        'update_refused' => 'Beatrax ha scaricato la versione :version e ha rifiutato di installarla: il file non corrispondeva alla firma dell\'editore, quindi non è stato modificato nulla su questo dispositivo. Un download danneggiato può causarlo. Se continua a succedere, non installare Beatrax da quella fonte.',
        ...
        'schema_shape_drifted' => 'Su questo dispositivo mancano alcune delle protezioni che Beatrax integra nel database, quindi un\'eliminazione può portarsi via record collegati senza dirlo e un\'impostazione può essere salvata in una forma che Beatrax non riesce a rileggere. Nulla di quello che hai inserito è andato perso. Beatrax ripara ciò che può a ogni avvio, quindi un riavvio di solito risolve.',
        ...
        'sync_blind_index_diverged' => 'Due dei tuoi dispositivi hanno attivato la cifratura a riposo separatamente, prima che li abbinassi, quindi ciascuno riconosce gli esercenti con la propria chiave. Tutto continua a sincronizzarsi, ma un esercente che un dispositivo conosce è uno sconosciuto per l’altro: gli esercenti compaiono due volte e un pagamento ricorrente può essere rilevato due volte. Beatrax non unirà le due chiavi, perché quella che scarterebbe porterebbe con sé la cronologia di corrispondenze propria di quel dispositivo. La via d’uscita è configurare di nuovo da zero uno dei dispositivi e lasciargli prendere la sua copia dall’altro.',

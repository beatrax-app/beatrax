...
return [
    ...
    'messages' => [
        ...
        'update_refused' => 'Beatrax stáhl verzi :version a odmítl ji nainstalovat — soubor neodpovídal podpisu vydavatele, takže se na tomto zařízení nic nezměnilo. Může to způsobit poškozené stažení. Pokud se to opakuje, neinstaluj Beatrax z tohoto zdroje.',
        ...
        'sync_blind_index_diverged' => 'Dvě z vašich zařízení zapnula šifrování v klidu každé zvlášť, ještě než jste je spárovali, takže každé rozpoznává obchodníky pod vlastním klíčem. Vše se stále synchronizuje, ale obchodník, kterého zná jedno zařízení, je pro druhé cizí: obchodníci se objevují dvakrát a opakovaná platba může být nalezena dvakrát. Beatrax oba klíče nesloučí, protože ten, který by zahodil, by si s sebou vzal vlastní historii shod daného zařízení. Cesta zpět je nastavit jedno zařízení znovu od nuly a nechat je převzít svou kopii z toho druhého.',

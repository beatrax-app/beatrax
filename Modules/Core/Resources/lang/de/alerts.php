...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'die übrigen Hinweise',
    ],
    ...
    'messages' => [
        ...
        'schema_shape_drifted' => 'Ein Teil der Schutzmechanismen, die Beatrax in die Datenbank einbaut, fehlt auf diesem Gerät. Dadurch kann ein Löschvorgang verknüpfte Einträge unbemerkt mitnehmen, und eine Einstellung kann in einer Form gespeichert werden, die Beatrax nicht zurücklesen kann. Nichts von dem, was du eingegeben hast, ist verloren. Beatrax repariert bei jedem Start, was es kann, ein Neustart behebt das also meistens.',
        ...
        'sync_blind_index_diverged' => 'Zwei Ihrer Geräte haben die Verschlüsselung im Ruhezustand getrennt voneinander eingeschaltet, bevor Sie sie gekoppelt haben, sodass jedes Gerät Händler unter seinem eigenen Schlüssel erkennt. Es wird weiterhin alles synchronisiert, aber ein Händler, den das eine Gerät kennt, ist dem anderen ein Fremder: Händler erscheinen doppelt, und eine wiederkehrende Zahlung kann zweimal gefunden werden. Beatrax führt die beiden Schlüssel nicht zusammen, denn der Schlüssel, den es dabei fallen ließe, nähme die eigene Zuordnungshistorie dieses Geräts mit. Ein Gerät von Grund auf neu einzurichten und es seine Kopie vom anderen übernehmen zu lassen, bringt die beiden wieder zusammen.',

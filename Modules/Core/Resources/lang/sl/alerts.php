...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'druga opozorila',
    ],
    ...
    'messages' => [
        ...
        'sync_blind_index_diverged' => 'Dve napravi sta šifriranje v mirovanju vklopili vsaka zase, še preden ste ju seznanili, zato vsaka prepozna trgovce s svojim ključem. Vse se še naprej sinhronizira, a trgovec, ki ga pozna ena naprava, je za drugo tujec: trgovci se prikažejo dvakrat, ponavljajoče se plačilo pa je mogoče najti dvakrat. Beatrax obeh ključev ne bo združil, ker bi tisti, ki bi ga opustil, s seboj odnesel lastno zgodovino ujemanj te naprave. Izhod je eno napravo znova nastaviti od začetka in ji pustiti, da svojo kopijo prevzame od druge.',

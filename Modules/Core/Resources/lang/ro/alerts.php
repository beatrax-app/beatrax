...
return [
    ...
    'messages' => [
        ...
        'schema_shape_drifted' => 'Pe acest dispozitiv lipsesc o parte dintre protecțiile pe care Beatrax le integrează în baza de date, așa că o ștergere poate lua cu ea înregistrări asociate fără să anunțe, iar o setare poate fi salvată într-o formă pe care Beatrax nu o poate citi înapoi. Nimic din ce ați introdus nu s-a pierdut. Beatrax repară la fiecare pornire ce poate, așa că o repornire rezolvă de obicei acest lucru.',
        ...
        'sync_blind_index_diverged' => 'Două dintre dispozitivele tale au activat criptarea în repaus separat, înainte să le împerechezi, așa că fiecare recunoaște comercianții după propria cheie. Totul se sincronizează în continuare, dar un comerciant pe care îl știe un dispozitiv este un străin pentru celălalt: comercianții apar de două ori, iar o plată recurentă poate fi găsită de două ori. Beatrax nu va contopi cele două chei, pentru că aceea la care ar renunța ar lua cu ea istoricul de potriviri al dispozitivului respectiv. Ieșirea este să configurezi din nou un dispozitiv de la zero și să îl lași să își ia copia de la celălalt.',

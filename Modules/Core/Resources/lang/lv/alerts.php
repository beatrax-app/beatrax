...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'pārējos brīdinājumus',
    ],
    ...
    'messages' => [
        ...
        'sync_blind_index_diverged' => 'Divas jūsu ierīces miera stāvokļa šifrēšanu ieslēdza katra atsevišķi, vēl pirms jūs tās sapārojāt, tāpēc katra tirgotājus atpazīst pēc savas atslēgas. Viss joprojām sinhronizējas, taču tirgotājs, ko pazīst viena ierīce, otrai ir svešs: tirgotāji parādās divreiz, un regulārs maksājums var tikt atrasts divas reizes. Beatrax abas atslēgas neapvienos, jo tā, kuru tas atmestu, paņemtu līdzi šīs ierīces pašas sakritību vēsturi. Izeja ir vienu ierīci iestatīt no jauna no nulles un ļaut tai paņemt savu kopiju no otras.',

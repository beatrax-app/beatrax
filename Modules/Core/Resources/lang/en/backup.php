...
return [
    ...
    'errors' => [
        ...
        'choose_file' => 'Choose what to restore from: the .enc backup file, or the .zip the one-click export wrote.',
        ...
        'restore_not_a_backup' => 'This file holds no Beatrax backup, so there is nothing in it to restore and nothing has been changed. Pick the .enc file the app wrote when you made the backup, or the .zip the one-click export wrote.',

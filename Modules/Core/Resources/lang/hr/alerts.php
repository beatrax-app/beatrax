...
return [
    ...
    'messages' => [
        ...
        'sync_blind_index_diverged' => 'Dva su uređaja uključila šifriranje u mirovanju svaki za sebe, prije nego što ste ih uparili, pa svaki prepoznaje trgovce pod vlastitim ključem. Sve se i dalje sinkronizira, ali trgovac kojeg jedan uređaj poznaje drugome je stranac: trgovci se pojavljuju dvaput, a ponavljajuće plaćanje može se pronaći dva puta. Beatrax neće spojiti dva ključa jer bi onaj koji bi odbacio sa sobom odnio vlastitu povijest podudaranja tog uređaja. Izlaz je postaviti jedan uređaj iznova od nule i pustiti ga da svoju kopiju preuzme s drugoga.',

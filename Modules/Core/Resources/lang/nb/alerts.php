...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'de øvrige varslene',
    ],
    ...
    'messages' => [
        ...
        'schema_shape_drifted' => 'Noen av beskyttelsene Beatrax bygger inn i databasen mangler på denne enheten, så en sletting kan ta med seg tilknyttede oppføringer uten å si fra, og en innstilling kan bli lagret i en form Beatrax ikke kan lese tilbake. Ingenting av det du har lagt inn har gått tapt. Beatrax reparerer det den kan hver gang den starter, så en omstart løser dette som regel.',
        ...
        'sync_blind_index_diverged' => 'To av enhetene dine slo på kryptering i hvile hver for seg, før du paret dem, så hver enhet gjenkjenner forhandlere med sin egen nøkkel. Alt synkroniseres fortsatt, men en forhandler som den ene enheten kjenner, er en fremmed for den andre: forhandlere dukker opp to ganger, og en gjentakende betaling kan bli funnet to ganger. Beatrax slår ikke sammen de to nøklene, for den som ble forkastet, ville ta med seg den enhetens egen treffhistorikk. Veien tilbake er å sette opp den ene enheten på nytt fra bunnen av og la den hente sin kopi fra den andre.',

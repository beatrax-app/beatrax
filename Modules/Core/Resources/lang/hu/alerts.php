...
return [
    ...
    'messages' => [
        ...
        'sync_blind_index_diverged' => 'Két eszköze külön-külön kapcsolta be a nyugalmi állapotú titkosítást, még mielőtt párosította volna őket, így mindegyik a saját kulcsával ismeri fel a kereskedőket. Minden továbbra is szinkronizálódik, de az a kereskedő, akit az egyik eszköz ismer, a másiknak idegen: a kereskedők kétszer jelennek meg, és egy ismétlődő fizetés is kétszer található meg. A Beatrax nem vonja össze a két kulcsot, mert amelyiket eldobná, az magával vinné az adott eszköz saját egyeztetési előzményeit. A kiút az, hogy az egyik eszközt a nulláról állítja be újra, és hagyja, hogy a másiktól vegye át a másolatát.',

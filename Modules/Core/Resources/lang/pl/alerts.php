...
return [
    ...
    'messages' => [
        ...
        'update_refused' => 'Beatrax pobrał wersję :version i odmówił jej zainstalowania — plik nie zgadzał się z podpisem wydawcy, więc nic na tym urządzeniu nie zostało zmienione. Może to powodować uszkodzone pobieranie. Jeśli powtarza się to dalej, nie instaluj Beatraxa z tego źródła.',
        ...
        'sync_blind_index_diverged' => 'Dwa twoje urządzenia włączyły szyfrowanie w spoczynku osobno, zanim zostały sparowane, więc każde rozpoznaje sprzedawców pod własnym kluczem. Wszystko nadal się synchronizuje, ale sprzedawca, którego zna jedno urządzenie, jest obcy dla drugiego: sprzedawcy pojawiają się dwa razy, a płatność cykliczna może zostać wykryta dwukrotnie. Beatrax nie połączy tych dwóch kluczy, bo ten, który by odrzucił, zabrałby ze sobą własną historię dopasowań tego urządzenia. Wyjściem jest skonfigurowanie jednego urządzenia od zera i pozwolenie mu, by wzięło swoją kopię z drugiego.',

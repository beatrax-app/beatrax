...
return [
    ...
    'messages' => [
        ...
        'schema_shape_drifted' => 'Nogle af de beskyttelser, Beatrax bygger ind i databasen, mangler på denne enhed, så en sletning kan tage tilknyttede poster med sig uden at sige det, og en indstilling kan blive gemt i en form, Beatrax ikke kan læse tilbage. Intet af det, du har indtastet, er gået tabt. Beatrax reparerer det, den kan, hver gang den starter, så en genstart løser det som regel.',
        ...
        'sync_blind_index_diverged' => 'To af dine enheder slog kryptering i hvile til hver for sig, før du parrede dem, så hver enhed genkender forhandlere under sin egen nøgle. Alt bliver stadig synkroniseret, men en forhandler, som den ene enhed kender, er en fremmed for den anden: forhandlere dukker op to gange, og en tilbagevendende betaling kan findes to gange. Beatrax fletter ikke de to nøgler sammen, for den, der blev droppet, ville tage den pågældende enheds egen matchhistorik med sig. Vejen tilbage er at sætte den ene enhed op helt forfra og lade den hente sin kopi fra den anden.',

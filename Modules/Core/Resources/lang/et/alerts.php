...
return [
    ...
    'messages' => [
        ...
        'sync_blind_index_diverged' => 'Kaks sinu seadet lülitasid puhkeoleku krüptimise sisse eraldi, enne kui sa need sidusid, nii et kumbki tunneb kaupmehi ära oma võtme järgi. Kõik sünkroonitakse endiselt, aga kaupmees, keda üks seade tunneb, on teisele võõras: kaupmehed ilmuvad kaks korda ja korduvmakse võidakse leida kaks korda. Beatrax neid kahte võtit kokku ei liida, sest see, mille ta kõrvale jätaks, viiks kaasa selle seadme enda vastavuste ajaloo. Väljapääs on seadistada üks seade uuesti nullist ja lasta sel võtta oma koopia teiselt.',

...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'os restantes alertas',
    ],
    ...
    'messages' => [
        ...
        'schema_shape_drifted' => 'Faltam neste dispositivo algumas das proteções que o Beatrax integra na base de dados, por isso apagar algo pode levar consigo registos associados sem avisar e uma definição pode ser guardada num formato que o Beatrax não consegue voltar a ler. Nada do que introduziu se perdeu. O Beatrax repara o que pode sempre que arranca, por isso reiniciar costuma resolver isto.',
        ...
        'sync_blind_index_diverged' => 'Dois dos seus dispositivos ativaram a cifragem em repouso separadamente, antes de os ter emparelhado, pelo que cada um reconhece os comerciantes com a sua própria chave. Tudo continua a sincronizar, mas um comerciante que um dispositivo conhece é um estranho para o outro: os comerciantes aparecem duas vezes e um pagamento recorrente pode ser detetado duas vezes. O Beatrax não vai juntar as duas chaves, porque aquela que descartasse levaria consigo o histórico de correspondências do próprio dispositivo. A saída é voltar a configurar um dos dispositivos de raiz e deixá-lo obter a sua cópia a partir do outro.',

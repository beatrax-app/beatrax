...
return [
    ...
    'about_updates' => [
        ...
        'body_phone' => 'Aqui o Beatrax não se atualiza sozinho. As novas versões da app para telemóvel chegam pela App Store ou pelo Google Play, tal como as tuas outras apps.',

...
return [
    ...
    'errors' => [
        ...
        'restore_not_a_backup' => 'Šis failas nėra šifruota Beatrax atsarginė kopija, todėl nėra ką atkurti ir niekas nebuvo pakeista. Pasirink .enc failą, kurį programa įrašė kuriant kopiją.',

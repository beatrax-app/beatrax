...
return [
    ...
    'messages' => [
        ...
        'sync_blind_index_diverged' => 'Du jūsų įrenginiai ramybės būsenos šifravimą įjungė atskirai, dar prieš jums juos susiejant, todėl kiekvienas prekybininkus atpažįsta pagal savo raktą. Viskas vis tiek sinchronizuojama, bet prekybininkas, kurį pažįsta vienas įrenginys, kitam yra svetimas: prekybininkai rodomi po du kartus, o pasikartojantis mokėjimas gali būti aptiktas du kartus. Beatrax šių dviejų raktų nesulies, nes tas, kurio jis atsisakytų, kartu nusineštų to įrenginio atitikmenų istoriją. Išeitis — vieną įrenginį nustatyti iš naujo nuo nulio ir leisti jam pasiimti savo kopiją iš kito.',

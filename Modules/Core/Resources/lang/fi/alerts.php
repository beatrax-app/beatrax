...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'muita huomautuksia',
    ],
    ...
    'messages' => [
        ...
        'sync_blind_index_diverged' => 'Kaksi laitettasi otti levossa olevan salauksen käyttöön erikseen, ennen kuin paritit ne, joten kumpikin tunnistaa kauppiaat omalla avaimellaan. Kaikki synkronoituu edelleen, mutta kauppias, jonka toinen laite tuntee, on toiselle vieras: kauppiaat näkyvät kahteen kertaan ja toistuva maksu voidaan löytää kahdesti. Beatrax ei yhdistä kahta avainta, koska hylätty avain veisi mukanaan sen laitteen oman tunnistushistorian. Ulospääsy on määrittää toinen laite uudelleen alusta ja antaa sen ottaa kopionsa toiselta.',

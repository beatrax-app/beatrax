...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'de övriga varningarna',
    ],
    ...
    'messages' => [
        ...
        'sync_blind_index_diverged' => 'Två av dina enheter slog på kryptering i vila var för sig, innan du parkopplade dem, så varje enhet känner igen handlare med sin egen nyckel. Allt synkroniseras fortfarande, men en handlare som den ena enheten känner är en främling för den andra: handlare dyker upp två gånger, och en återkommande betalning kan hittas två gånger. Beatrax slår inte ihop de två nycklarna, eftersom den som förkastades skulle ta med sig den enhetens egen matchningshistorik. Vägen tillbaka är att sätta upp den ena enheten på nytt från grunden och låta den hämta sin kopia från den andra.',

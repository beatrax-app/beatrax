...
return [
    ...
    'errors' => [
        ...
        'choose_file' => 'Välj vad du vill återställa från: .enc-filen med säkerhetskopian eller .zip-filen som exporten med ett klick skrev.',
        ...
        'restore_not_a_backup' => 'Den här filen innehåller ingen Beatrax-säkerhetskopia, så det finns inget att återställa och inget har ändrats. Välj .enc-filen som appen skrev när du gjorde säkerhetskopian, eller .zip-filen som exporten med ett klick skrev.',

...
return [
    ...
    'deferred_pass' => [
        ...
        'withheld-triggers' => 'ostatné upozornenia',
    ],
    ...
    'messages' => [
        ...
        'schema_shape_drifted' => 'Na tomto zariadení chýba časť ochrán, ktoré Beatrax zabudováva do databázy, takže odstránenie môže potichu vziať so sebou prepojené záznamy a nastavenie sa môže uložiť v podobe, ktorú Beatrax nedokáže prečítať späť. Nič z toho, čo ste zadali, sa nestratilo. Beatrax pri každom spustení opraví, čo môže, takže reštart to zvyčajne vyrieši.',
        ...
        'sync_blind_index_diverged' => 'Dve zariadenia zapli šifrovanie v pokoji každé osobitne, ešte predtým, než ste ich spárovali, takže každé rozpoznáva obchodníkov pod vlastným kľúčom. Všetko sa naďalej synchronizuje, ale obchodník, ktorého pozná jedno zariadenie, je pre druhé cudzí: obchodníci sa objavujú dvakrát a opakovaná platba sa dá nájsť dva razy. Beatrax tieto dva kľúče nezlúči, pretože ten, ktorý by zahodil, by si so sebou vzal vlastnú históriu zhôd daného zariadenia. Cesta späť je nastaviť jedno zariadenie znova od nuly a nechať ho prevziať svoju kópiu z toho druhého.',

 ...
 * configured minimum (PHP 8.5). The comparison matches against
 * major.minor only so alpha / beta / RC builds of the minimum
 * version still pass — the operator's intent in installing
 * "PHP 8.5-RC1" is to be on 8.5, not to be rejected for it.
 *

...
final class DoctorCommand extends Command
{
    ...
    public function __construct(
        ...
        private readonly ?UntranslatedParentHealthCheck $untranslatedParentHealth = null,
    ) {
        parent::__construct();
    }
    ...
    public function handle(): int
    {
        ...
        foreach ([$this->schemaShapeHealth, $this->ftsHealth, $this->fingerprintHealth, $this->splitSumHealth, $this->strandedCreateHealth, $this->untranslatedParentHealth] as $health) {
            if ($health === null) {
                continue;
            }

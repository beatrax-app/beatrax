 ...
 * any filename that does not match the `diederik-YYYY-MM-DD-HHMMSS.sqlite`
...
dataset('retention scenarios', [
    ...
    '14 consecutive daily files: 7 newest dailies plus 2 Sundays among older 7' => [
        ...
        'candidates' => [
            'diederik-2026-05-06-030000.sqlite',
            'diederik-2026-05-07-030000.sqlite',
            'diederik-2026-05-08-030000.sqlite',
            'diederik-2026-05-09-030000.sqlite',
            'diederik-2026-05-10-030000.sqlite', // Sunday
            'diederik-2026-05-11-030000.sqlite',
            'diederik-2026-05-12-030000.sqlite',
            'diederik-2026-05-13-030000.sqlite',
            'diederik-2026-05-14-030000.sqlite',
            'diederik-2026-05-15-030000.sqlite',
            'diederik-2026-05-16-030000.sqlite',
            'diederik-2026-05-17-030000.sqlite', // Sunday
        ...
        'expectedKeepers' => [
            'diederik-2026-05-10-030000.sqlite',
            'diederik-2026-05-13-030000.sqlite',
            'diederik-2026-05-14-030000.sqlite',
            'diederik-2026-05-15-030000.sqlite',
            'diederik-2026-05-16-030000.sqlite',
    ...
    '8 weeks of Sundays plus a couple of weekday dailies: 7 newest dailies + 4 most-recent Sundays' => [
        ...
        'candidates' => [
            'diederik-2026-03-29-030000.sqlite',
            'diederik-2026-04-05-030000.sqlite',
            'diederik-2026-04-12-030000.sqlite',
            'diederik-2026-04-19-030000.sqlite',
            'diederik-2026-04-26-030000.sqlite',
            'diederik-2026-05-03-030000.sqlite',
            'diederik-2026-05-10-030000.sqlite',
            'diederik-2026-05-17-030000.sqlite',
            'diederik-2026-05-18-030000.sqlite',
            'diederik-2026-05-19-030000.sqlite',
    ...
    'two same-day timestamps both count as separate dailies' => [
        ...
        'candidates' => [
            ...
            'diederik-2026-05-18-030000.sqlite',
            'diederik-2026-05-19-030000.sqlite',
            'diederik-2026-05-19-153000.sqlite',
        ],
    ...
    'suspect + pre-restore + meta.json files are always passed through unchanged' => [
        'candidates' => [
            ...
            'diederik-2026-05-12-030000.sqlite',
            'diederik-2026-05-12-030000.sqlite.meta.json',
            'diederik-2026-05-13-030000.sqlite',
            'diederik-2026-05-13-030000.sqlite.meta.json',
            'diederik-2026-05-14-030000.sqlite',
            'diederik-2026-05-14-030000.sqlite.meta.json',
            'diederik-2026-05-15-030000.sqlite',
            'diederik-2026-05-16-030000.sqlite',
            'diederik-2026-05-17-030000.sqlite', // Sunday
            'diederik-2026-05-18-030000.sqlite',

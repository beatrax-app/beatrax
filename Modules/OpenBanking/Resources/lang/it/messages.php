...
return [
    ...
    'page' => [
        ...
        'connect_another' => 'Collega un\'altra banca',
        'credentials_unreadable' => 'Impossibile leggere le credenziali open banking salvate su questo dispositivo, quindi Beatrax non riesce a collegarsi alla tua banca.',
        'credentials_unreadable_next' => 'Esegui di nuovo la configurazione guidata per sostituirle. Le transazioni già importate non vengono modificate.',
    ...
    'status_row' => [
        ...
        'revoked' => 'La tua banca ha chiuso la connessione: riconnettiti.',
    ...
    'transparency' => [
        ...
        'pill_revoked' => 'Chiusa dalla tua banca: riconnetti',
        ...
        'reason_error' => 'errore',
        'reason_truncated' => 'interrotta in anticipo',
        'reason_nothing_imported' => 'non è stato possibile registrare nulla',
        'reason_consent_revoked' => 'chiusa dalla tua banca',
        'disconnect_button' => 'Scollega',
    ],

    'consent_banner' => [
        'heading' => 'Consenso scaduto — ricollega',
        'heading_revoked' => 'La tua banca ha chiuso la connessione',
        'body' => "L'ultima sincronizzazione riuscita è stata :when. Ricollega per riprendere la sincronizzazione automatica.",
        'body_revoked' => 'La tua banca o Enable Banking ha revocato l’accesso, quindi la sincronizzazione si è fermata. L’ultima sincronizzazione riuscita è stata :when. Riconnettiti per riprenderla.',
        'never' => 'mai',
        'reconnect' => 'Ricollega',
    ],
    ...
    'sync' => [
        ...
        'auto_caption' => 'Una sincronizzazione viene tentata automaticamente una volta al giorno.',
        ...
        'none_importable' => 'La tua banca ha inviato transazioni, ma non è stato possibile registrarne nessuna. Apri la revisione dell’importazione per vedere perché.',
        'in_progress' => 'Una sincronizzazione è già in corso. Riprova tra un momento.',
        'truncated' => 'La tua banca aveva più transazioni di quante una sincronizzazione possa recuperarne, quindi questa esecuzione si è interrotta in anticipo. Non è stato registrato nulla come sincronizzato: la prossima sincronizzazione ripartirà dallo stesso punto.',
    ],
    ...
    'wizard' => [
        ...
        'step5_body' => "Fai clic qui sotto per aprire la schermata di accesso e consenso della tua banca. Completa l'accesso e l'eventuale passaggio a 2 fattori, poi torna a questa finestra per finire di attivare Open Banking.",
        // i18n-review: it · step5_body_touch — the same line for a touch
        // screen; check the verb governs this case.
        'step5_body_touch' => "Tocca qui sotto per aprire la schermata di accesso e consenso della tua banca. Completa l'accesso e l'eventuale passaggio a 2 fattori, poi torna su Beatrax e riapri questa schermata per finire di attivare Open Banking.",
    ...
    'errors' => [
        ...
        'consent_not_completed' => 'La tua banca non ha completato la connessione. Non è cambiato nulla: riprova a connetterti.',
    ],
];

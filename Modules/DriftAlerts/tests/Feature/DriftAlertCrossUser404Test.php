...
/*
 * End-to-end cross-user isolation for the three DriftAlerts Public
 * Actions. Each action MUST raise NotFoundHttpException when invoked
 * against an alert belonging to a different user; the underlying row
 * MUST stay untouched; zero transitions rows MUST be written.
 *

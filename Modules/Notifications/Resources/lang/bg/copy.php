...
return [
    ...
    'digest' => [
        ...
        'net_worth' => 'Нетна стойност :amount.',
        ...
        'forecast_not_run' => 'Все още не е правена прогноза за паричния поток.',
        'forecast_running' => 'В момента се изпълнява прогноза за паричния поток.',
    ],
];

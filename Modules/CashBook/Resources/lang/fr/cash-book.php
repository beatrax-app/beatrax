...
return [
    ...
    'intro' => 'Enregistre à la main les dépenses en espèces et les autres dépenses hors banque. Les saisies manuelles rejoignent le même registre que tes imports — elles sont catégorisées, analysées pour la récurrence et comptent dans ton mois.',
    ...
    'errors' => [
        ...
        'amount_unreadable' => 'Ce montant n’a pas pu être lu. Saisissez-le sans séparateur de milliers et avec deux décimales au maximum, par exemple :example.',

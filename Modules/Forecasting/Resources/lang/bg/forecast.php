...
return [
    ...
    'run_failed' => 'Тази прогноза не можа да бъде изчислена. Линията по-долу показва само това, което вече е осчетоводено.',
    ...
    'projection_range' => 'Прогнозен интервал',
    'point_estimate' => 'Точкова оценка',
    ...
    'stale_run' => 'Прогноза от :date — оттогава не е обновявана.',
    ...
    'errors' => [
        ...
        'amount_decimals' => 'Сумата трябва да е число с най-много :decimals десетичен знак.|Сумата трябва да е число с най-много :decimals десетични знака.',
        'amount_whole' => 'Сумата трябва да е цяло число — тази валута няма по-малка единица.',
        'amount_non_negative' => 'Сумата трябва да е нула или положителна.',
        'amount_non_zero' => 'Сумата не може да е нула.',
        'field_required' => 'Полето :field е задължително.',
    ],
];

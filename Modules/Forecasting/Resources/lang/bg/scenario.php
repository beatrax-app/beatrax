...
return [
    ...
    'kind' => [
        ...
        'shift_series_date' => [
            ...
            'desc' => 'Премества следващото или всички последващи появявания на друга дата.',
        ],
    ],
    ...
    'template' => [
        ...
        'change_amount' => 'Промени сумата на :name',
    ],
    ...
    'toast' => [
        ...
        'mutation_removed' => 'Промяната е премахната.',
    ],
    ...
    'errors' => [
        ...
        'date_out_of_range' => 'Тази дата е извън всеки прогнозен хоризонт — от днес до :days ден напред — затова сценарият не би променил нищо.|Тази дата е извън всеки прогнозен хоризонт — от днес до :days дни напред — затова сценарият не би променил нищо.',
        'pick_kind_first' => 'Първо избери вид промяна.',
        'amount_positive' => 'Сумата трябва да е положително число.',
        'scenario_gone' => 'Този сценарий вече го няма — изтрит е другаде. Избери друг сценарий или създай нов.',
        'mutation_gone' => 'Тази промяна вече я няма — премахната е другаде. Затвори редактора и я добави отново, ако още я искаш.',
    ],
];

...
return [
    ...
    'errors' => [
        ...
        'name_too_long' => 'Назва сценарію має містити не більше ніж :max символ.|Назва сценарію має містити не більше ніж :max символи.|Назва сценарію має містити не більше ніж :max символів.',

...
return [
    ...
    'kind' => [
        ...
        'shift_series_date' => [
            ...
            'desc' => 'Перенести наступне або всі подальші повторення на іншу дату.',
        ],
    ],
    ...
    'template' => [
        ...
        'change_amount' => 'Змінити суму: :name',
    ],
    ...
    'toast' => [
        ...
        'mutation_removed' => 'Зміну видалено.',
    ],
    ...
    'errors' => [
        ...
        'date_out_of_range' => 'Ця дата поза кожним горизонтом прогнозу — від сьогодні до :days дня наперед — тож сценарій нічого не змінить.|Ця дата поза кожним горизонтом прогнозу — від сьогодні до :days днів наперед — тож сценарій нічого не змінить.|Ця дата поза кожним горизонтом прогнозу — від сьогодні до :days днів наперед — тож сценарій нічого не змінить.',
        'pick_kind_first' => 'Спершу обери тип зміни.',
        'amount_positive' => 'Сума має бути додатним числом.',
        'scenario_gone' => 'Цього сценарію більше немає — його видалено в іншому місці. Вибери інший сценарій або створи новий.',
        'mutation_gone' => 'Цієї зміни більше немає — її вилучено в іншому місці. Закрий редактор і додай її знову, якщо вона тобі ще потрібна.',
    ],
];

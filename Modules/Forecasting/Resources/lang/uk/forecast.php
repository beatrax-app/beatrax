...
return [
    ...
    'aggregate_subtitle' => 'Сукупний баланс за всіма рахунками, спрогнозований на наступні :days днів.',
    ...
    'updating' => 'Оновлення',
    'chart_noscript' => 'Для графіка потрібен JavaScript. Діапазон охоплює :days днів.',
    ...
    'highlights_shortfall_aria' => 'Активних вікон дефіциту в наступні 30 днів: :count',

...
return [
    ...
    'run_failed' => 'Не вдалося обчислити цей прогноз. Лінія нижче показує лише те, що вже проведено.',
    ...
    'projection_range' => 'Діапазон прогнозу',
    'point_estimate' => 'Точкова оцінка',
    ...
    'stale_run' => 'Прогноз від :date — відтоді не оновлювався.',
    ...
    'errors' => [
        ...
        'amount_decimals' => 'Сума має бути числом щонайбільше з :decimals десятковим знаком.|Сума має бути числом щонайбільше з :decimals десятковими знаками.|Сума має бути числом щонайбільше з :decimals десятковими знаками.',
        'amount_whole' => 'Сума має бути цілим числом — ця валюта не має меншої одиниці.',
        'amount_non_negative' => 'Сума має бути нулем або додатною.',
        'amount_non_zero' => 'Сума не може дорівнювати нулю.',
        'field_required' => 'Поле :field обов’язкове.',
    ],
];

...
return [
    ...
    'run_failed' => 'Δεν ήταν δυνατός ο υπολογισμός αυτής της πρόβλεψης. Η γραμμή παρακάτω δείχνει μόνο ό,τι έχει ήδη καταχωριστεί.',
    ...
    'projection_range' => 'Εύρος πρόβλεψης',
    'point_estimate' => 'Κεντρική εκτίμηση',
    ...
    'stale_run' => 'Πρόβλεψη από :date — δεν έχει ανανεωθεί έκτοτε.',
    ...
    'errors' => [
        'amount_required' => 'Το ποσό είναι υποχρεωτικό.',
        'amount_decimals' => 'Το ποσό πρέπει να είναι αριθμός με το πολύ :decimals δεκαδικό ψηφίο.|Το ποσό πρέπει να είναι αριθμός με το πολύ :decimals δεκαδικά ψηφία.',
        'amount_whole' => 'Το ποσό πρέπει να είναι ακέραιος — αυτό το νόμισμα δεν έχει μικρότερη μονάδα.',
        'amount_non_negative' => 'Το ποσό πρέπει να είναι μηδέν ή θετικό.',
        'amount_non_zero' => 'Το ποσό δεν μπορεί να είναι μηδέν.',

...
return [
    ...
    'aggregate_subtitle' => 'Συνολικό υπόλοιπο σε όλους τους λογαριασμούς, προβαλλόμενο για τις επόμενες :days ημέρες.',
    ...
    'updating' => 'Ενημέρωση',
    'chart_noscript' => 'Το γράφημα απαιτεί JavaScript. Το εύρος καλύπτει :days ημέρες.',
    ...
    'highlights_shortfall_aria' => ':count ενεργά παράθυρα ελλείμματος τις επόμενες 30 ημέρες',

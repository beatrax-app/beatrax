...
it('indexes the counterparty name a resolved receipt conflict wrote', function (): void {
    $conflictId = (int) DB::table('pending_enrichment_conflicts')->insertGetId([
        'user_id' => $this->fixtureUser->id,
        'transaction_id' => $this->transaction->id,
        'field_name' => 'counterparty_name',
        'stored_value' => json_encode('NLPAYPAL 4RTX9', JSON_THROW_ON_ERROR),
        'incoming_value' => json_encode('Albert Heijn', JSON_THROW_ON_ERROR),
        'incoming_source_format' => SourceFormat::Eml->value,
        'import_run_id' => $this->transaction->import_run_id,
        'created_at' => CarbonImmutable::now()->toDateTimeString(),
        'updated_at' => CarbonImmutable::now()->toDateTimeString(),
    ]);

    app(ApplyReceiptConflictResolution::class)(
        $this->fixtureUser,

...
return [
    'wizard' => [
        'intro' => 'Пусни имейл съобщение (.eml) или архив на пощенска кутия (.mbox). Съпоставянето разпознава разписките от PayPal и ги показва като канонични транзакции; несъпоставените податели остават в одитния дневник за сортиране.',
    ],

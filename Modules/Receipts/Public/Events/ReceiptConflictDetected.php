 ...
 * receipt — and the user's `receipt_conflict_resolution` setting is
 * still `'unset'`.
 *
 * The toast listener (Phase 7 Wave 3 onwards) surfaces a one-time
 * choice: prefer the receipt's value going forward, or keep the
 * first-write value. The chosen policy is persisted to
 * `users.receipt_conflict_resolution`; subsequent conflicts apply it
 * automatically without further prompts.
 *

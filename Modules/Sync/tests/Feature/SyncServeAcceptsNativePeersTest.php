...
/*
 * AllowOriginAcceptor compares the request's Origin header against its list
 * with in_array(), so ['*'] matched the LITERAL string and every upgrade came
 * back "403 Origin forbidden" — a native peer sends no Origin at all. Noise
 * is the authentication gate here, not a browser header.
 */

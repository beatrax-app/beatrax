...
return [
    ...
    'cancel_pairing' => 'Odustani od uparivanja',

    'enter_the_code' => 'Unesi kod',
    'enter_code_aria' => 'Unesi kod od riječi s drugog uređaja',
    'submit_code' => 'Pošalji kod',

    'compare_words' => 'Usporedi ove riječi s drugim uređajem',
    'safety_number_words' => 'Riječi sigurnosnog broja:',
    'compare_help' => 'Oba uređaja moraju prikazivati potpuno iste riječi. Ako se razlikuju, dodirni Odustani od uparivanja — možda je u tijeku napad posrednika.',
    'waiting_for_peer' => 'Čekanje potvrde s drugog uređaja...',
    'confirm_match' => 'Potvrdi — podudaraju se',

    'device_paired' => 'Uređaj je uparen',
    'device_paired_help' => 'Ovaj je uređaj sada pouzdan. Tvoji će se podaci sinkronizirati čim se povežeš.',
    'done' => 'Gotovo',
    ...
    'cannot_be_answered' => 'Na kod prikazan ovdje nitko ne bi mogao odgovoriti: ovaj uređaj nije dostupan preko mreže i nije postavljen relej. Prikaži kod drugog uređaja i unesi ga ovdje.',

...
return [
    ...
    'introduced_heading' => 'Vouched for by another device',
    'introduced_trust' => 'Another of your devices has passed on the identity of a device this one never paired with. Confirming lets this device check what that device signed, and nothing else — it cannot connect here, and it is never sent a key. There is no second screen to compare against, so what you are trusting is the device that passed it on.',
    'introduced_by' => 'Introduced by :name',
    'introduced_confirmed' => 'Confirmed for signatures',
    'introduced_unconfirmed' => 'Not confirmed',
    'introduced_fingerprint' => 'Fingerprint of the key that arrived:',
    'introduced_withheld' => ':count change cannot be read until you confirm|:count changes cannot be read until you confirm',

...
return [
    ...
    'introduced_heading' => 'Toisen laitteen takaama',
    'introduced_trust' => 'Toinen laitteistasi on välittänyt sellaisen laitteen identiteetin, jonka kanssa tämä laite ei ole koskaan muodostanut laiteparia. Vahvistaminen antaa tämän laitteen tarkistaa, mitä tuo laite on allekirjoittanut, eikä mitään muuta — se ei voi yhdistää tänne, eikä sille koskaan lähetetä avainta. Vertailtavaa toista näyttöä ei ole, joten luotat siihen laitteeseen, joka identiteetin välitti.',
    'introduced_by' => 'Välittäjä: :name',
    'introduced_confirmed' => 'Vahvistettu allekirjoituksia varten',
    'introduced_unconfirmed' => 'Ei vahvistettu',
    'introduced_fingerprint' => 'Saapuneen avaimen sormenjälki:',
    'introduced_withheld' => ':count muutos jää lukematta, kunnes vahvistat|:count muutosta jää lukematta, kunnes vahvistat',

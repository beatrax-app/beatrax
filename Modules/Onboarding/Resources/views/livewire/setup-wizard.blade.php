            ...
            @foreach ($stepKeys as $index => $stepKey)
                @php
                    ...
                    $dotClass = match (true) {
                        ...
                        $status === \Modules\Onboarding\Internal\Enums\WizardStepStatus::Done->value, $status === \Modules\Onboarding\Internal\Enums\WizardStepStatus::Skipped->value => 'wiz-dot done',
                        default => 'wiz-dot',
                    };
                @endphp

...
return [
    ...
    'section' => [
        ...
        'left_out' => 'Egy fájl itt kimaradt, ezért csak a többi lesz mentve: :reason|:count fájl itt kimaradt, ezért csak a többi lesz mentve: :reason',
        'rows_skipped' => 'Néhány sort itt nem sikerült beolvasni, ezért kimaradnak: :reason',

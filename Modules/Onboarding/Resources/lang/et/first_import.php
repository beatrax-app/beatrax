...
return [
    ...
    'section' => [
        ...
        'left_out' => 'Üks fail siin jäeti välja, seega salvestatakse ainult ülejäänud: :reason|:count faili siin jäeti välja, seega salvestatakse ainult ülejäänud: :reason',
        'rows_skipped' => 'Mõnda siinset rida ei õnnestunud lugeda ja need jäetakse vahele: :reason',

...
return [
    ...
    'section' => [
        ...
        'left_out' => 'En fil här utelämnades, så bara resten sparas: :reason|:count filer här utelämnades, så bara resten sparas: :reason',
        'rows_skipped' => 'Vissa rader här gick inte att läsa och hoppas över: :reason',

...
return [
    ...
    'section' => [
        ...
        'left_out' => 'Eén bestand hier is weggelaten, dus alleen de rest wordt vastgelegd: :reason|:count bestanden hier zijn weggelaten, dus alleen de rest wordt vastgelegd: :reason',
        'rows_skipped' => 'Sommige regels hier konden niet worden gelezen en worden overgeslagen: :reason',

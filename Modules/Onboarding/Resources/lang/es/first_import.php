...
return [
    ...
    'section' => [
        ...
        'left_out' => 'Se ha omitido un archivo, así que solo se guardará el resto: :reason|Se han omitido :count archivos, así que solo se guardará el resto: :reason',
        'rows_skipped' => 'Algunas filas de aquí no se han podido leer y se omitirán: :reason',

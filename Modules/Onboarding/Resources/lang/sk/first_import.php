...
return [
    ...
    'section' => [
        ...
        'left_out' => 'Jeden súbor tu bol vynechaný, uloží sa preto len zvyšok: :reason|:count súbory tu boli vynechané, uloží sa preto len zvyšok: :reason|:count súborov tu bolo vynechaných, uloží sa preto len zvyšok: :reason',
        'rows_skipped' => 'Niektoré riadky sa tu nepodarilo načítať a budú preskočené: :reason',

...
return [
    ...
    'section' => [
        ...
        'left_out' => 'Un file qui è stato escluso, quindi verrà salvato solo il resto: :reason|:count file qui sono stati esclusi, quindi verrà salvato solo il resto: :reason',
        'rows_skipped' => 'Alcune righe qui non sono state leggibili e verranno saltate: :reason',

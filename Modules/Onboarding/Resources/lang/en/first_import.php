...
return [
    ...
    'section' => [
        ...
        'left_out' => 'One file here was left out, so only the rest will be committed: :reason|:count files here were left out, so only the rest will be committed: :reason',
        'rows_skipped' => 'Some rows here could not be read and will be skipped: :reason',

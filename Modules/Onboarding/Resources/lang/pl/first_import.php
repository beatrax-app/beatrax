...
return [
    ...
    'section' => [
        ...
        'left_out' => 'Jeden plik został tu pominięty, więc zapisana zostanie tylko reszta: :reason|:count pliki zostały tu pominięte, więc zapisana zostanie tylko reszta: :reason|:count plików zostało tu pominiętych, więc zapisana zostanie tylko reszta: :reason',
        'rows_skipped' => 'Niektórych wierszy tutaj nie udało się odczytać i zostaną pominięte: :reason',

            ...
            <div class="space-y-3">
                ...
                <form wire:submit="confirm" class="space-y-4" x-data="{ typed: @entangle('typed') }">
                    ...
                    <div class="flex items-center justify-end gap-2 pt-2">
                        ...
                        <button
                            type="submit"
                            class="inline-flex items-center rounded-md bg-rose-600 px-4 py-2 text-sm font-medium text-white hover:bg-rose-700 disabled:cursor-not-allowed disabled:bg-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-600 focus-visible:ring-offset-2 dark:bg-rose-500 dark:hover:bg-rose-400 dark:disabled:bg-slate-600"

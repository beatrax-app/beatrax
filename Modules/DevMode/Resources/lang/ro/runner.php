...
return [
    ...
    'command' => [
        'db_backup' => ['label' => 'Fă o copie de rezervă a bazei de date', 'description' => 'Scrie o copie SQLite cu marcaj de timp în directorul de copii de rezervă (sau la calea dată).'],
        ...
        'migrate_fresh' => ['label' => 'Șterge tabelele și migrează din nou', 'description' => 'Șterge fiecare tabel, apoi rulează din nou fiecare migrare.'],
        'reset_password' => ['label' => 'Resetează parola', 'description' => 'Resetează interactiv parola unui utilizator (refuză folosirea neinteractivă).'],
    ...
    'arg' => [
        'destination' => ['label' => 'Fișier destinație', 'help' => 'Lasă gol ca să folosești directorul implicit de copii de rezervă.', 'placeholder' => '/cale/către/backup.sqlite (opțional)'],
        ...
        'from' => ['label' => 'Calea fișierului de copie de rezervă', 'help' => 'Înlocuiește baza de date curentă cu fișierul de la calea dată.', 'placeholder' => '/cale/către/backup.sqlite'],

...
return [
    ...
    'command' => [
        ...
        'demo_seed' => ['label' => 'Завантажити зразкові дані', 'description' => 'Додає зразкову книгу — рахунки, транзакції, бюджети, цілі та сповіщення — вигадану, щоб побачити застосунок із вмістом. Вона додається до того, що вже є, а не замінює його, і ніщо з неї не є даними реальної людини.'],

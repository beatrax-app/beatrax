...
return [
    ...
    'action' => [
        ...
        'scan_email' => ['label' => 'Сканирай имейла сега', 'hint' => 'Стартирай веднага синхронизацията на пощенската кутия'],
        'open_profile' => ['label' => 'Отвори профила', 'hint' => 'Настройки — профил и предпочитания'],
        'toggle_theme' => ['label' => 'Смени темата', 'hint' => 'Превключване между светла и тъмна тема'],
    ],
    ...
    'nav' => [
        ...
        'audit' => ['label' => 'Одитен дневник за разработка', 'hint' => 'Всяко действие в режима за разработка'],

...
return [
    ...
    'unavailable_counterparty' => 'Контрагентът го няма на това устройство',
    'unavailable_account' => 'Сметката я няма на това устройство',
    'title' => 'Отчети',
    ...
    'period' => [
        ...
        'to' => 'До',
        'error' => [
            'incomplete' => 'Избери начална и крайна дата.',
            'malformed' => 'Използвай валидна дата във формат ГГГГ-ММ-ДД.',
            'inverted' => 'Крайната дата е преди началната.',
            'unknown_preset' => 'Това не е един от предлаганите периоди. Избери от списъка.',
        ],
    ],
    ...
    'filters' => [
        'heading' => 'Филтри',
        'net_worth_note' => 'Нетната стойност е салдо: важи само филтърът по сметка.',
    ],
    ...
    'chart' => [
        'other_currencies' => 'Графиката е в :currency — :list не се показва',
        'undrawn' => 'Извън пръстена — :amount се движи в обратната посока',
    ...
    'other_movement' => 'Такси и корекции (не са включени по-горе)',
    'other_movement_with_refunds' => 'Такси, възстановявания и корекции (не са включени по-горе)',
];

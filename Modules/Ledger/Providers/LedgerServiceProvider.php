...
use Modules\Ledger\Public\Actions\DeleteTransaction;
...
final class LedgerServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(AnchorsStartingBalanceFromStatements::class, BackfillStartingBalanceFromStatementSummaries::class);

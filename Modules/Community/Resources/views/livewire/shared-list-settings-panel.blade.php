...
<div class="settings-section grid grid-cols-1 gap-6 border-b border-slate-200 py-6 md:grid-cols-[280px_1fr] dark:border-slate-700">
    <aside class="meta-side rounded-md bg-slate-50 px-5 py-5 text-sm text-slate-700 dark:bg-slate-900 dark:text-slate-300">
        <h2 class="text-base font-semibold text-slate-900 dark:text-slate-100">About the shared list</h2>
    ...
    <div class="body-side space-y-1">
        <div class="toggle-row flex items-start justify-between gap-4 border-b border-slate-200 py-3 dark:border-slate-700">
            <div class="flex-1">
                <p class="text-sm font-medium text-slate-900 dark:text-slate-100">Use the shared merchant list</p>
                <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                    Let beatrax read the bundled list to fill in friendly names for merchants you have not renamed yourself.
                </p>
            </div>
            <label for="toggle-use-shared-list" class="cursor-pointer">
                <span class="sr-only">Use the shared merchant list</span>
                <input
                    type="checkbox"
        ...
        <div class="toggle-row flex items-start justify-between gap-4 border-b border-slate-200 py-3 dark:border-slate-700">
            <div class="flex-1">
                <p class="text-sm font-medium text-slate-900 dark:text-slate-100">Offer to contribute</p>
                <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                    Show the "Help others identify this" CTA on the triage row so you can submit a suggestion to the shared list with one click.
                </p>
            </div>
            <label for="toggle-offer-to-contribute" class="cursor-pointer">
                <span class="sr-only">Offer to contribute</span>
                <input
                    type="checkbox"
        ...
        <div class="toggle-row flex items-start justify-between gap-4 py-3">
            <div class="flex-1">
                <p class="text-sm font-medium text-slate-900 dark:text-slate-100">Update the shared list on app updates</p>
                <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                    Refresh the bundled list every time beatrax updates itself.
                </p>
                <p class="mt-1 text-xs italic text-slate-400 dark:text-slate-500" data-testid="toggle-update-note">
                    Activates with a future app update — see Settings → About for the current version.
                </p>
            </div>
            <label for="toggle-update-on-updates" class="cursor-not-allowed">
                <span class="sr-only">Update the shared list on app updates</span>
                <input
                    type="checkbox"

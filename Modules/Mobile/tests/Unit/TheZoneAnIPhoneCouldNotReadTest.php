...
it('anchors on text the shipped app really carries', function (): void {
    ...
    if (! is_file($candidate)) {
        test()->markTestSkipped(
            'mobile-app/nativephp/ios/NativePHP/NativePHPApp.swift is generated by a native build, '
            .'which no CI job runs — so this anchor is answered in no job at all. It reported a pass '

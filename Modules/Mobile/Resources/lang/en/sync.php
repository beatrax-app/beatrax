...
return [
    ...
    'background_note' => 'Beatrax keeps listening while it is open, so a paired device can sync with this one at any time. Sync now starts an exchange from this side.',
    'background_note_phone' => 'Syncing happens when you tap Sync now. It cannot run in the background — the app lock holds the only key.',
    'network' => 'Network',

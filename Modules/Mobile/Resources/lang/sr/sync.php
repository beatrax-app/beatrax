...
return [
    ...
    'result' => [
        ...
        'not_secured' => 'Tvoj drugi uređaj se javio, ali sigurna veza sa njim nije mogla da se otvori. Otključaj Beatrax na tom uređaju i pokušaj ponovo; ako i dalje ne uspeva, ponovo upari oba uređaja.',
    ...
    'background_note' => 'Beatrax osluškuje dok je otvoren, pa upareni uređaj može da se sinhronizuje sa ovim u bilo kom trenutku. Sinhronizuj sada pokreće razmenu podataka sa ove strane.',
    'background_note_phone' => 'Sinhronizacija se dešava kad dodirneš Sinhronizuj sada. U pozadini ne može da radi — zaključavanje aplikacije čuva jedini ključ.',
    'network' => 'Mreža',

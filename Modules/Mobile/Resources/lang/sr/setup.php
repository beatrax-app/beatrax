...
return [
    'blocked' => [
        'no_peer' => 'Čeka se da drugi uređaj završi potvrdu.',
        'no_keys' => 'Čekaju se ključevi za šifrovanje sa drugog uređaja.',
        'unreachable' => 'Nije moguće dopreti do drugog uređaja — proveri da li su oba na istoj mreži.',
    ...
    'step' => [
        ...
        'transfer' => 'Prenos tvoje istorije',

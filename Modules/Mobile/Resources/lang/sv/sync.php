...
return [
    ...
    'background_note' => 'Beatrax lyssnar så länge det är öppet, så en parkopplad enhet kan synkronisera med den här när som helst. Synkronisera nu startar ett datautbyte härifrån.',
    'background_note_phone' => 'Synkronisering sker när du trycker på Synkronisera nu. Den kan inte köra i bakgrunden — applåset har den enda nyckeln.',
    'network' => 'Nätverk',

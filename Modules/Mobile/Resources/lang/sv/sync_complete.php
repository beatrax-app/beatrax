...
return [
    ...
    'automatic_body' => 'Allt du ändrar på den ena enheten dyker upp på den andra. Det finns ingen synkroniseringsknapp att trycka på.',
    ...
    'relay_body' => 'Ändringar väntar krypterade på din relay tills den andra enheten är online igen, och landar sedan automatiskt.',
    'no_relay_title' => 'När du är borta',
    'no_relay_body' => 'Ändringar väntar på den här enheten och synkroniseras nästa gång båda är på ditt hemnätverk samtidigt.',

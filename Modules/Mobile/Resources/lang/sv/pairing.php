...
return [
    ...
    'camera_off_no_search' => 'Kameraåtkomst är av, och att söka efter den andra enheten på nätverket fungerar inte på iPhone ännu — så en inskriven kod kan inte hitta den på egen hand. Slå på kameraåtkomst för Beatrax igen i enhetsinställningarna och skanna koden på den andra enheten, eller skicka koden här så frågar den här skärmen var den finns.',
    'no_search' => 'Att söka efter den andra enheten på nätverket fungerar inte på iPhone ännu, så en inskriven kod kan inte hitta den på egen hand. Skanna koden med kameran i stället — den behöver ingen nätverkssökning. Om du inte kan skanna, skicka koden så frågar den här skärmen var den andra enheten finns.',
    'word_code_aria' => 'Ange ordkoden från den andra enheten',
    'initiator_address' => 'Var är den andra enheten?',
    'initiator_address_help' => 'Dess adress på det här nätverket, som host och port. Datorn visar den under Enheter och synkronisering. Skicka koden igen när du har fyllt i den.',
    ...
    'errors' => [
        ...
        'initiator_address_invalid' => 'Det är ingen adress som den här enheten kan ringa upp. Ange den som host och port, till exempel 192.168.1.20:8100.',
        ...
        'no_peer_answered_local_network' => 'Inget på det här nätverket svarade på koden. Beatrax behöver först din tillåtelse att nå enheter på det här nätverket, och utan den fungerar ingen väg till den andra enheten — inte kameran heller. Slå på Lokalt nätverk för Beatrax i enhetens inställningar och skicka koden igen.',

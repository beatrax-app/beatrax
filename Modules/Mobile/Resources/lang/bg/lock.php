...
return [
    ...
    'forgot_pin' => 'Забрави ли ПИН кода? Излез',
    ...
    'errors' => [
        ...
        'pin_changed' => 'ПИН кодът за това устройство беше променен по време на отключването. Въведи текущия ПИН код.',

        'biometric_reset' => 'Биометричното отключване беше нулирано. Въведи ПИН кода си, след което го включи отново от Заключване на приложението.',
    ],
];

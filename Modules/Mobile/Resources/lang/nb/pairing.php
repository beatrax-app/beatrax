...
return [
    ...
    'camera_off_no_search' => 'Kameratilgang er av, og søk etter den andre enheten på nettverket virker ikke på iPhone ennå — så en skrevet kode finner den ikke på egen hånd. Slå på kameratilgang for Beatrax igjen i enhetsinnstillingene og skann koden på den andre enheten, eller send koden her, så spør denne skjermen hvor den er.',
    'no_search' => 'Søk etter den andre enheten på nettverket virker ikke på iPhone ennå, så en skrevet kode finner den ikke på egen hånd. Skann koden med kameraet i stedet — det trenger ingen nettverkssøk. Kan du ikke skanne, send koden, så spør denne skjermen hvor den andre enheten er.',
    'word_code_aria' => 'Skriv inn ordkoden fra den andre enheten',
    'initiator_address' => 'Hvor er den andre enheten?',
    'initiator_address_help' => 'Adressen dens på dette nettverket, som host og port. Datamaskinen viser den under Enheter og synkronisering. Send koden på nytt når du har skrevet den inn.',
    ...
    'errors' => [
        ...
        'initiator_address_invalid' => 'Det er ikke en adresse denne enheten kan ringe opp. Skriv den inn som host og port, for eksempel 192.168.1.20:8100.',
        ...
        'no_peer_answered_local_network' => 'Ingenting på dette nettverket svarte på koden. Beatrax trenger først tillatelsen din til å nå enheter på dette nettverket, og uten den virker ingen vei til den andre enheten — heller ikke kameraet. Slå på Lokalt nettverk for Beatrax i innstillingene på enheten, og send koden på nytt.',

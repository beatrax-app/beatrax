...
return [
    'blocked' => [
        'no_peer' => 'Venter på at den andre enheten skal bli ferdig med å bekrefte.',
        'no_keys' => 'Venter på krypteringsnøklene fra den andre enheten.',
        'unreachable' => 'Får ikke kontakt med den andre enheten — sjekk at begge er på samme nettverk.',
        'reprojecting' => 'Bygger opp historikken din på nytt…',
        'retrying' => 'Kobler til den andre enheten på nytt…',
        'locked' => 'Lås opp appen for å fortsette oppsettet.',
    ],
    'step' => [
        'connect' => 'Kobler til den andre enheten din',
        'keys' => 'Mottar krypteringsnøkler',
        'transfer' => 'Overfører historikken din',

...
return [
    ...
    'camera_off_no_search' => 'Kameraadgang er slået fra, og søgning efter den anden enhed på netværket virker ikke på iPhone endnu — så en indtastet kode kan ikke finde den selv. Slå kameraadgang til Beatrax til igen i dine enhedsindstillinger og scan koden på den anden enhed, eller send koden her, og dette skærmbillede spørger, hvor den er.',
    'no_search' => 'Søgning efter den anden enhed på netværket virker ikke på iPhone endnu, så en indtastet kode kan ikke finde den selv. Scan koden med kameraet i stedet — det kræver ingen netværkssøgning. Kan du ikke scanne, så send koden, og dette skærmbillede spørger, hvor den anden enhed er.',
    'word_code_aria' => 'Indtast ordkoden fra den anden enhed',
    'initiator_address' => 'Hvor er den anden enhed?',
    'initiator_address_help' => 'Dens adresse på dette netværk, som host og port. Computeren viser den under Enheder og synkronisering. Send koden igen, når du har indtastet den.',
    ...
    'encryption_incomplete' => 'Krypteringen af de data, der er gemt på denne enhed, blev ikke fuldført. Dataene er endnu ikke gemt krypteret.',
    'done' => 'Færdig',

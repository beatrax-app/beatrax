...
return [
    ...
    'result' => [
        ...
        'not_secured' => 'Tvoja druga naprava se je odzvala, vendar varne povezave z njo ni bilo mogoče vzpostaviti. Odkleni Beatrax na tej napravi in poskusi znova; če še vedno ne gre, znova seznani obe napravi.',
    ...
    'background_note' => 'Beatrax posluša ves čas, ko je odprt, zato se lahko seznanjena naprava s to sinhronizira kadar koli. Sinhroniziraj zdaj začne izmenjavo podatkov s te strani.',
    'background_note_phone' => 'Sinhronizacija se zgodi, ko se dotakneš Sinhroniziraj zdaj. V ozadju ne more teči — zaklep aplikacije hrani edini ključ.',
    'network' => 'Omrežje',

...
return [
    'blocked' => [
        'no_peer' => 'Wachten tot het andere apparaat bevestigt.',
        'no_keys' => 'Wachten op de sleutels van het andere apparaat.',
        'unreachable' => 'Geen verbinding met het andere apparaat — controleer of beide op hetzelfde netwerk zitten.',
    ...
    'step' => [
        ...
        'transfer' => 'Je historie overzetten',

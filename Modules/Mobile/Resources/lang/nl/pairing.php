...
return [
    ...
    'camera_off_no_search' => 'Cameratoegang staat uit, en zoeken naar het andere apparaat op het netwerk werkt nog niet op de iPhone — dus een getypte code kan het niet zelf vinden. Zet cameratoegang voor Beatrax weer aan in je apparaatinstellingen en scan de code op het andere apparaat, of verstuur de code hier en dit scherm vraagt waar het andere apparaat staat.',
    'no_search' => 'Zoeken naar het andere apparaat op het netwerk werkt nog niet op de iPhone, dus een getypte code kan het niet zelf vinden. Scan de code met de camera — daarvoor is geen netwerkzoekopdracht nodig. Lukt scannen niet, verstuur de code dan en dit scherm vraagt waar het andere apparaat staat.',
    'word_code_aria' => 'Voer de woordcode van het andere apparaat in',
    'initiator_address' => 'Waar staat het andere apparaat?',
    'initiator_address_help' => 'Het adres op dit netwerk, als host en poort. De desktop toont dit bij Apparaten en synchronisatie. Verstuur de code opnieuw zodra je het hebt ingevuld.',
    ...
    'encryption_incomplete' => 'Het versleutelen van de gegevens op dit apparaat is niet afgerond. De gegevens worden nog niet versleuteld opgeslagen.',
    'done' => 'Klaar',

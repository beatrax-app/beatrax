...
return [
    ...
    'camera_off_no_search' => 'Dostęp do aparatu jest wyłączony, a wyszukiwanie drugiego urządzenia w sieci nie działa jeszcze na iPhonie — więc wpisany kod sam go nie znajdzie. Włącz z powrotem dostęp do aparatu dla Beatrax w ustawieniach urządzenia i zeskanuj kod pokazany na drugim urządzeniu albo wyślij kod tutaj, a ten ekran zapyta, gdzie ono jest.',
    'no_search' => 'Wyszukiwanie drugiego urządzenia w sieci nie działa jeszcze na iPhonie, więc wpisany kod sam go nie znajdzie. Zeskanuj kod aparatem — nie potrzebuje wyszukiwania w sieci. Jeśli nie możesz zeskanować, wyślij kod, a ten ekran zapyta, gdzie jest drugie urządzenie.',
    'word_code_aria' => 'Wpisz kod słowny z drugiego urządzenia',
    'initiator_address' => 'Gdzie jest drugie urządzenie?',
    'initiator_address_help' => 'Jego adres w tej sieci, jako host i port. Komputer pokazuje go w sekcji Urządzenia i synchronizacja. Wyślij kod ponownie, gdy go wpiszesz.',

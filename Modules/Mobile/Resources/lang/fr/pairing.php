...
return [
    ...
    'camera_off_no_search' => "L'accès à l'appareil photo est désactivé, et la recherche de l'autre appareil sur le réseau ne fonctionne pas encore sur iPhone — un code saisi ne peut donc pas le trouver seul. Réactive l'accès à l'appareil photo pour Beatrax dans les réglages, puis scanne le code affiché sur l'autre appareil, ou envoie le code ici et cet écran te demandera où il se trouve.",
    'no_search' => "La recherche de l'autre appareil sur le réseau ne fonctionne pas encore sur iPhone, donc un code saisi ne peut pas le trouver seul. Scanne plutôt le code avec l'appareil photo — il n'a besoin d'aucune recherche réseau. Si tu ne peux pas scanner, envoie le code et cet écran te demandera où se trouve l'autre appareil.",
    'word_code_aria' => 'Saisis le code en mots affiché sur l\'autre appareil',
    'initiator_address' => "Où se trouve l'autre appareil ?",
    'initiator_address_help' => "Son adresse sur ce réseau, sous forme d'hôte et de port. L'ordinateur l'affiche sous Appareils et synchronisation. Renvoie le code une fois que tu l'as saisie.",
    ...
    'encryption_incomplete' => 'Le chiffrement des données stockées sur cet appareil n\'a pas abouti. Elles ne sont pas encore stockées chiffrées.',
    'done' => 'Terminé',
    ...
    'errors' => [
        ...
        'initiator_address_invalid' => "Ce n'est pas une adresse que cet appareil peut appeler. Saisis-la sous forme d'hôte et de port, par exemple 192.168.1.20:8100.",
        ...
        'no_peer_answered_local_network' => 'Rien sur ce réseau n’a répondu à ce code. Beatrax a d’abord besoin de ton autorisation pour joindre les appareils de ce réseau, et sans elle aucun chemin vers l’autre appareil ne fonctionne — pas même l’appareil photo. Active Réseau local pour Beatrax dans les paramètres de ton appareil, puis renvoie le code.',

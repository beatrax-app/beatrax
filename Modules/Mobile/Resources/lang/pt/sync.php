...
return [
    ...
    'result' => [
        ...
        'not_secured' => 'O teu outro dispositivo respondeu, mas não foi possível abrir uma ligação segura. Desbloqueia o Beatrax nesse dispositivo e tenta de novo; se continuar a falhar, emparelha os dois dispositivos outra vez.',
    ...
    'background_note' => 'O Beatrax continua à escuta enquanto está aberto, por isso um dispositivo emparelhado pode sincronizar com este a qualquer momento. Sincronizar agora inicia uma troca de dados a partir deste lado.',
    'background_note_phone' => 'A sincronização acontece quando tocas em Sincronizar agora. Não pode correr em segundo plano — o bloqueio da app guarda a única chave.',
    'network' => 'Rede',

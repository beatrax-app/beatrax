...
return [
    ...
    'camera_off_no_search' => 'O acesso à câmara está desligado e procurar o outro dispositivo na rede ainda não funciona no iPhone, por isso um código escrito não o consegue encontrar sozinho. Volta a ligar o acesso à câmara para o Beatrax nas definições do dispositivo e lê o código mostrado no outro dispositivo, ou envia o código aqui e este ecrã pergunta-te onde está.',
    'no_search' => 'Procurar o outro dispositivo na rede ainda não funciona no iPhone, por isso um código escrito não o consegue encontrar sozinho. Lê o código com a câmara — não precisa de qualquer procura na rede. Se não puderes ler, envia o código e este ecrã pergunta-te onde está o outro dispositivo.',
    'word_code_aria' => 'Introduz o código de palavras do outro dispositivo',
    'initiator_address' => 'Onde está o outro dispositivo?',
    'initiator_address_help' => 'O seu endereço nesta rede, como host e porta. O computador mostra-o em Dispositivos e sincronização. Envia o código outra vez depois de o introduzires.',
    ...
    'encryption_incomplete' => 'A cifragem dos dados guardados neste dispositivo não foi concluída. Os dados ainda não são guardados cifrados.',
    'done' => 'Concluído',

...
return [
    ...
    'result' => [
        ...
        'not_secured' => 'Il tuo altro dispositivo ha risposto, ma non è stato possibile aprire una connessione sicura. Sblocca Beatrax su quel dispositivo e riprova; se continua a non funzionare, accoppia di nuovo i due dispositivi.',
    ...
    'background_note' => 'Beatrax resta in ascolto finché è aperto, così un dispositivo abbinato può sincronizzarsi con questo in qualsiasi momento. Sincronizza ora avvia uno scambio di dati da questo lato.',
    'background_note_phone' => 'La sincronizzazione avviene quando tocchi Sincronizza ora. Non può girare in background — il blocco app custodisce l\'unica chiave.',
    'network' => 'Rete',

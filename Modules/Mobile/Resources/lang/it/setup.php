...
return [
    'blocked' => [
        'no_peer' => "In attesa che l'altro dispositivo completi la conferma.",
        'no_keys' => "In attesa delle chiavi di crittografia dall'altro dispositivo.",
        'unreachable' => "Impossibile raggiungere l'altro dispositivo — controlla che siano entrambi sulla stessa rete.",
    ...
    'step' => [
        ...
        'transfer' => 'Trasferimento della tua cronologia',

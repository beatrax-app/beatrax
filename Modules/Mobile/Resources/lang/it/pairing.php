...
return [
    ...
    'camera_off_no_search' => "L'accesso alla fotocamera è disattivato e la ricerca dell'altro dispositivo in rete non funziona ancora su iPhone, quindi un codice digitato non può trovarlo da solo. Riattiva l'accesso alla fotocamera per Beatrax nelle impostazioni del dispositivo e scansiona il codice mostrato sull'altro dispositivo, oppure invia il codice qui e questa schermata ti chiederà dov'è.",
    'no_search' => "La ricerca dell'altro dispositivo in rete non funziona ancora su iPhone, quindi un codice digitato non può trovarlo da solo. Scansiona il codice con la fotocamera — non serve alcuna ricerca in rete. Se non puoi scansionare, invia il codice e questa schermata ti chiederà dov'è l'altro dispositivo.",
    'word_code_aria' => "Inserisci il codice a parole dell'altro dispositivo",
    'initiator_address' => "Dov'è l'altro dispositivo?",
    'initiator_address_help' => 'Il suo indirizzo su questa rete, come host e porta. Il computer lo mostra in Dispositivi e sincronizzazione. Invia di nuovo il codice dopo averlo inserito.',
    ...
    'encryption_incomplete' => 'La cifratura dei dati salvati su questo dispositivo non è stata completata. I dati non sono ancora archiviati cifrati.',
    'done' => 'Fatto',
    ...
    'errors' => [
        ...
        'initiator_address_invalid' => 'Non è un indirizzo che questo dispositivo possa contattare. Inseriscilo come host e porta, ad esempio 192.168.1.20:8100.',
        ...
        'no_peer_answered_local_network' => 'Niente su questa rete ha risposto a quel codice. Beatrax ha prima bisogno del tuo permesso per raggiungere i dispositivi su questa rete e senza di esso non funziona nessuna strada verso l’altro dispositivo — nemmeno la fotocamera. Attiva Rete locale per Beatrax nelle impostazioni del dispositivo, poi invia di nuovo il codice.',

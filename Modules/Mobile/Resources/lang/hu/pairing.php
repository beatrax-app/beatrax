...
return [
    ...
    'camera_off_no_search' => 'A kamera-hozzáférés ki van kapcsolva, és a másik eszköz keresése a hálózaton iPhone-on még nem működik — így a begépelt kód magától nem találja meg. Kapcsold vissza a Beatrax kamera-hozzáférését az eszköz beállításaiban, és olvasd be a másik eszközön látható kódot, vagy küldd be a kódot itt, és ez a képernyő megkérdezi, hol van.',
    'no_search' => 'A másik eszköz keresése a hálózaton iPhone-on még nem működik, így a begépelt kód magától nem találja meg. Olvasd be a kódot a kamerával — ahhoz nem kell hálózati keresés. Ha nem tudsz beolvasni, küldd be a kódot, és ez a képernyő megkérdezi, hol van a másik eszköz.',
    'word_code_aria' => 'Add meg a másik eszközön látható szókódot',
    'initiator_address' => 'Hol van a másik eszköz?',
    'initiator_address_help' => 'A címe ezen a hálózaton, gazdagépként és portként. A számítógép az Eszközök és szinkronizálás alatt mutatja. Küldd be a kódot újra, ha megadtad.',
    ...
    'encryption_incomplete' => 'Az ezen az eszközön tárolt adatok titkosítása nem fejeződött be. Az adatok tárolása még nem titkosított.',
    'done' => 'Kész',

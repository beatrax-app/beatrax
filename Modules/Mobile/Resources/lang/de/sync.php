...
return [
    ...
    'result' => [
        ...
        'not_secured' => 'Dein anderes Gerät hat geantwortet, aber es kam keine sichere Verbindung zustande. Entsperre Beatrax auf diesem Gerät und versuch es erneut; klappt es weiterhin nicht, koppel die beiden Geräte neu.',
    ...
    'background_note' => 'Beatrax hört zu, solange es geöffnet ist, sodass ein gekoppeltes Gerät sich jederzeit mit diesem synchronisieren kann. Jetzt synchronisieren startet einen Datenaustausch von dieser Seite aus.',
    'background_note_phone' => 'Synchronisiert wird, wenn du auf Jetzt synchronisieren tippst. Im Hintergrund geht das nicht — die App-Sperre hält den einzigen Schlüssel.',
    'network' => 'Netzwerk',

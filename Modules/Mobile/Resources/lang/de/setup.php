...
return [
    'blocked' => [
        'no_peer' => 'Warten, bis das andere Gerät die Bestätigung abschließt.',
        'no_keys' => 'Warten auf die Verschlüsselungsschlüssel vom anderen Gerät.',
        'unreachable' => 'Das andere Gerät ist nicht erreichbar — prüfe, ob beide im selben Netzwerk sind.',
    ...
    'step' => [
        ...
        'transfer' => 'Deinen Verlauf übertragen',
    ...
    'records' => ':applied von :expected Datensätzen',

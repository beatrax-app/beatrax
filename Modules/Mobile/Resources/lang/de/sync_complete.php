...
return [
    ...
    'records' => ':count Datensätze von :peer kopiert.',
    'records_none' => 'Auf dem Stand von :peer. Es gab nichts Neues zu kopieren.',
    'how_it_works' => 'Ab jetzt',
    'automatic_title' => 'Es hält sich selbst aktuell',
    'automatic_body' => 'Alles, was du auf einem der Geräte änderst, erscheint auf dem anderen. Es gibt keine Schaltfläche zum Synchronisieren.',
    ...
    'relay_body' => 'Änderungen warten verschlüsselt auf deinem Relay, bis das andere Gerät wieder online ist, und landen dann automatisch.',
    'no_relay_title' => 'Wenn du unterwegs bist',
    'no_relay_body' => 'Änderungen warten auf diesem Gerät und werden synchronisiert, sobald beide wieder gemeinsam in deinem Heimnetz sind.',

...
return [
    'country_moved_desc' => 'Maasi on nyt kielen vieressä Näkymä-osiossa. Se määrää edelleen, mitä vähennysluokkia täällä tarjotaan.',
    'country_moved_link' => 'Vaihda maata',

    'categories_label' => 'Vähennyskategoriat',
    'categories_desc' => 'Muokkaa merkitsemisessä käyttämiäsi kategorioita.',
    'categories_empty' => 'Ei vielä luokkia. Lisää ensimmäinen luokkasi tai valitse maasi, niin sen oletusluokat ladataan.',

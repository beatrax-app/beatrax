...
return [
    ...
    'batch_after' => ';',
    'batch_confirm' => 'Να επισημανθεί :count ακόμη συναλλαγή από :name για το φορολογικό έτος :year ως φορολογικά εκπιπτόμενη; Παίρνει αυτή την κατηγορία και αυτή τη σημείωση. Οι συναλλαγές σε ολοκληρωμένη συμφωνία μένουν ως έχουν και η αφαίρεση της επισήμανσης γίνεται μία συναλλαγή τη φορά.|Να επισημανθούν :count ακόμη συναλλαγές από :name για το φορολογικό έτος :year ως φορολογικά εκπιπτόμενες; Καθεμία παίρνει αυτή την κατηγορία και αυτή τη σημείωση. Οι συναλλαγές σε ολοκληρωμένη συμφωνία μένουν ως έχουν και η αφαίρεση της επισήμανσης γίνεται μία συναλλαγή τη φορά.',

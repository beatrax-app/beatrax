...
return [
    'country_moved_desc' => 'Ton pays se trouve désormais à côté de ta langue, dans Affichage. Il détermine toujours les catégories de déduction proposées ici.',
    'country_moved_link' => 'Changer de pays',

    'categories_label' => 'Catégories de déduction',
    'categories_desc' => 'Personnalise les postes que tu utilises pour marquer.',
    'categories_empty' => 'Aucune catégorie pour le moment. Ajoute ta première catégorie ou choisis ton pays pour charger celles par défaut.',
    ...
    'category_gone' => 'Catégorie introuvable (elle a peut-être été supprimée dans un autre onglet).',

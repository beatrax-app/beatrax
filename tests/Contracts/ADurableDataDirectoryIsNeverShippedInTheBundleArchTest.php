...
function bundleExclusionsOnlyOneShellNeeds(): array
{
    return [
        'desktop' => [
            ...
            '*/tests' => "the mobile packager's defaults already drop tests at any depth",
            '*/tools' => "the mobile packager keeps its vendor exclusions in nativephp/mobile's own pattern list",
            '*/docs' => "the mobile packager's vendor pattern list already drops a package's docs directory",
            '*/*.md' => "the mobile packager's vendor pattern list already drops markdown inside vendor packages",
            'tools' => 'the dev-only PHPStan rules, which only the desktop root carries',

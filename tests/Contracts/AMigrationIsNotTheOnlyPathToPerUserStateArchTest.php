...
it('leaves a reader who signed up matching no per-user sweep gate', function (): void {
    ...
    // Held to its claim like every other pin here: the sweep it excuses has to
    // still read the way the reason says, or the entry is excusing a sweep that
    // has since been rewritten into something else.
